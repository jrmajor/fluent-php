...
return [
    ...
    'microsecond' => new U(['one' => '{0} microsecond', 'other' => '{0} microseconds'], ['one' => '{0} μsec', 'other' => '{0} μsecs'], ['one' => '{0}μs', 'other' => '{0}μs']),
    ...
    'nanosecond' => new U(['one' => '{0} nanosecond', 'other' => '{0} nanoseconds'], ['one' => '{0} nanosec', 'other' => '{0} nanosecs'], ['one' => '{0}ns', 'other' => '{0}ns']),
