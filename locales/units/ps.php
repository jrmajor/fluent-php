...
return [
    ...
    'gallon' => new U(['one' => '{0} ګيلن', 'other' => '{0} ګيلنز'], '{0} gal', '{0} gal'),
    ...
    'inch' => new U(['one' => '{0} انچ', 'other' => '{0} انچې'], '{0} in', '{0} in'),
    ...
    'minute' => new U('{0} min', '{0} min', ['one' => '{0} min', 'other' => '{0}m']),
    ...
    'year' => new U(['one' => '{0} کال', 'other' => '{0} کالونه'], '{0} y', '{0} y'),
];
