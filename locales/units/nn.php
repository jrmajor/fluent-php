...
return [
    ...
    'byte' => new U('{0} byte', '{0} byte', ['one' => '{0}B', 'other' => '{0} byte']),
    ...
    'inch' => new U(['one' => '{0} tomme', 'other' => '{0} tommar'], ['one' => '{0} tomme', 'other' => '{0} tommar'], '{0}in'),
    ...
    'stone' => new U(['one' => '{0} engelsk stone', 'other' => '{0} engelske stones'], '{0} eng. st.', '{0} eng. st.'),
