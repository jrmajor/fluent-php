...
return [
    'day' => new U(['one' => '{0} día', 'other' => '{0} días'], ['one' => '{0} d.', 'other' => '{0} dd.'], ['one' => '{0}d.', 'other' => '{0}d.']),
    ...
    'second' => new U(['one' => '{0} segundo', 'other' => '{0} segundos'], ['one' => '{0} seg.', 'other' => '{0} seg.'], ['one' => '{0}s', 'other' => '{0}s']),
