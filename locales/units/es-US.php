...
return [
    ...
    'fahrenheit' => new U(['one' => '{0} grado Fahrenheit', 'other' => '{0} grados Fahrenheit'], ['one' => '{0} °F', 'other' => '{0} °F'], ['one' => '{0}°', 'other' => '{0}°']),
    'fluid-ounce' => new U(['one' => '{0} onza fluida', 'other' => '{0} onzas fluidas'], ['one' => '{0} fl oz', 'other' => '{0} fl oz'], ['one' => '{0}fl oz', 'other' => '{0}fl oz']),
    'mile-scandinavian' => new U(['one' => '{0} milla escandinava', 'other' => '{0} millas escandinavas'], ['one' => '{0} mil', 'other' => '{0} mil'], ['one' => '{0}mil', 'other' => '{0}mil']),
    ...
    'month' => new U(['one' => '{0} mes', 'other' => '{0} meses'], ['one' => '{0} m', 'other' => '{0} mm.'], ['one' => '{0}m', 'other' => '{0}m']),
    'week' => new U(['one' => '{0} semana', 'other' => '{0} semanas'], ['one' => '{0} sem.', 'other' => '{0} sems.'], ['one' => '{0}sem.', 'other' => '{0}sems.']),
    'year' => new U(['one' => '{0} año', 'other' => '{0} años'], ['one' => '{0} a', 'other' => '{0} aa.'], ['one' => '{0}a', 'other' => '{0}a']),
];
