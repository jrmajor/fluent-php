...
return [
    ...
    'foot' => new U(['one' => '{0} фут', 'few' => '{0} футы', 'many' => '{0} футаў', 'other' => '{0} фута'], '{0} фт', '{0} фт'),
    ...
    'gram' => new U(['one' => '{0} грам', 'few' => '{0} грамы', 'many' => '{0} грамаў', 'other' => '{0} грама'], '{0} г', '{0} г'),
    ...
    'inch' => new U(['one' => '{0} цаля', 'many' => '{0} цаляў', 'other' => '{0} цалі'], '{0} цал', '{0} цал'),
    ...
    'kilogram' => new U(['one' => '{0} кілаграм', 'few' => '{0} кілаграмы', 'many' => '{0} кілаграмаў', 'other' => '{0} кілаграма'], '{0} кг', '{0} кг'),
    ...
    'stone' => new U(['one' => '{0} стон', 'few' => '{0} стоны', 'many' => '{0} стонаў', 'other' => '{0} стона'], ['one' => '{0} стон', 'few' => '{0} стоны', 'many' => '{0} стонаў', 'other' => '{0} стона'], ['one' => '{0} стон', 'few' => '{0} стоны', 'many' => '{0} стонаў', 'other' => '{0} стона']),
