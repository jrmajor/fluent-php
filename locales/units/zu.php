...
return [
    'acre' => new U('{0} ac', '{0} ac', '{0}m²'),
    'bit' => new U(['one' => '{0} i-bit', 'other' => '{0} ama-bits'], '{0} bit', '{0}bit'),
    'byte' => new U(['one' => '{0} i-byte', 'other' => '{0} ama-bytes'], '{0} byte', '{0}B'),
    ...
    'foot' => new U('{0} ft', '{0} ft', ['one' => '{0}′', 'other' => '{0} ft']),
    ...
    'kilobit' => new U(['one' => '{0} i-kilobit', 'other' => '{0} ama-kilobits'], '{0} kb', '{0}Mb'),
    'kilobyte' => new U('{0} kB', '{0} kB', ['one' => '{0}Mb', 'other' => '{0} kB']),
    ...
    'milliliter' => new U('{0} mL', '{0} mL', '{0}cL'),
