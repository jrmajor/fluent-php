...
return [
    ...
    'day' => new U('{0} d', '{0} d', '{0} d'),
    'degree' => new U('{0}°', '{0}°', '{0}°'),
    'fahrenheit' => new U('{0}°F', '{0}°F', '{0}°F'),
    'fluid-ounce' => new U('{0} fl oz US', '{0} fl oz US', '{0} fl oz US'),
    'foot' => new U('{0} ft', '{0} ft', '{0} ft'),
    'gallon' => new U('{0} gal US', '{0} gal US', '{0} gal US'),
