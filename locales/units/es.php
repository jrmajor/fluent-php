...
return [
    ...
    'celsius' => new U(['one' => '{0} grado Celsius', 'other' => '{0} grados Celsius'], '{0} °C', '{0}°C'),
    'centimeter' => new U(['one' => '{0} centímetro', 'other' => '{0} centímetros'], '{0} cm', '{0}cm'),
    'day' => new U(['one' => '{0} día', 'other' => '{0} días'], '{0} d', '{0}d'),
    'degree' => new U(['one' => '{0} grado', 'other' => '{0} grados'], '{0}°', '{0}°'),
    'fahrenheit' => new U(['one' => '{0} grado Fahrenheit', 'other' => '{0} grados Fahrenheit'], '{0} °F', '{0}°F'),
    'fluid-ounce' => new U(['one' => '{0} onza líquida', 'other' => '{0} onzas líquidas'], '{0} fl oz', '{0}fl oz'),
    'foot' => new U(['one' => '{0} pie', 'other' => '{0} pies'], '{0} ft', '{0}ft'),
    'gallon' => new U(['one' => '{0} galón', 'other' => '{0} galones'], '{0} gal', '{0}gal'),
    ...
    'inch' => new U(['one' => '{0} pulgada', 'other' => '{0} pulgadas'], '{0} in', '{0}in'),
    'kilobit' => new U(['one' => '{0} kilobit', 'other' => '{0} kilobits'], '{0} kb', '{0}kb'),
    'kilobyte' => new U(['one' => '{0} kilobyte', 'other' => '{0} kilobytes'], '{0} kB', '{0}kB'),
    'kilogram' => new U(['one' => '{0} kilogramo', 'other' => '{0} kilogramos'], '{0} kg', '{0}kg'),
    'kilometer' => new U(['one' => '{0} kilómetro', 'other' => '{0} kilómetros'], '{0} km', '{0}km'),
    ...
    'percent' => new U('{0} por ciento', "{0}\u{A0}%", '{0}%'),
    ...
    'yard' => new U(['one' => '{0} yarda', 'other' => '{0} yardas'], '{0} yd', '{0}yd'),
