...
return [
    ...
    'month' => new U(['one' => '{0} mjesec', 'few' => '{0} mjeseca', 'other' => '{0} mjeseci'], '{0} mjes.', ['few' => '{0} mjes.', 'other' => '{0} m']),
    ...
    'second' => new U(['one' => '{0} sekunda', 'few' => '{0} sekunde', 'other' => '{0} sekundi'], '{0} sek', ['one' => '{0} sek', 'other' => '{0} s']),
    ...
    'week' => new U(['few' => '{0} nedjelje', 'other' => '{0} nedjelja'], '{0} ned.', ['one' => '{0} ned.', 'other' => '{0} n']),
    'yard' => new U(['one' => '{0} jard', 'few' => '{0} jarda', 'other' => '{0} jardi'], '{0} jrd', '{0} yd'),
    'year' => new U(['few' => '{0} godine', 'other' => '{0} godina'], ['one' => '{0} god', 'other' => '{0} god.'], ['few' => '{0} god.', 'other' => '{0} g']),
];
