...
return [
    ...
    'gigabit' => new U(['one' => '{0} gigabit', 'other' => '{0} gigabits'], '{0} Gb', '{0}Gbit'),
    ...
    'kilobit' => new U(['one' => '{0} kilobit', 'other' => '{0} kilobits'], '{0} kb', '{0}kbit'),
    ...
    'megabit' => new U(['one' => '{0} mégabit', 'other' => '{0} mégabits'], '{0} Mb', '{0}Mbit'),
    ...
    'terabit' => new U(['one' => '{0} térabit', 'other' => '{0} térabits'], '{0} Tb', '{0}Tbit'),
    ...
    'year' => new U(['one' => '{0} an', 'other' => '{0} ans'], ['one' => '{0} an', 'other' => '{0} ans'], '{0}a'),
];
