...
return [
    ...
    'BYN' => new C('BYN', 'Rubel Belarus baharu', narrow: 'р.', plurals: ['other' => 'Rubel Belarus']),
    'BYR' => new C('BYR', 'Rubel Belarus (2000–2016)', plurals: ['other' => 'Rubel Belarus (2000–2016)']),
    ...
    'MGF' => new C('MGF', 'Franc Malagasy', plurals: ['other' => 'Franc Malagasy']),
