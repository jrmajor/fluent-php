...
return [
    ...
    'LSL' => new C('LSL', 'Loti ya Lesoto', plurals: ['other' => 'Loti za Lesoto']),
    ...
    'MZM' => new C('MZM', 'Metikali ya Msumbiji (1980–2006)', plurals: ['other' => 'metikali ya Msumbiji (1980–2006)']),
    ...
    'PAB' => new C('PAB', 'Balboa ya Panama', plurals: ['other' => 'balboa ya Panama']),
    ...
    'QAR' => new C('QAR', 'Rial ya Qatar', plurals: ['other' => 'rial ya Qatar']),
