...
return [
    ...
    'AUD' => new C('AUD', 'Dola ya Australia', 'A$', '$', ['one' => 'dola ya Australia', 'other' => 'dola za Australia']),
    ...
    'BRL' => new C('BRL', 'Real ya Brazil', 'R$', 'R$', ['one' => 'Real ya Brazil', 'other' => 'Real za Brazil']),
    ...
    'CAD' => new C('CAD', 'Dola ya Canada', 'CA$', '$', ['one' => 'dola ya Canada', 'other' => 'dola za Canada']),
    ...
    'CNY' => new C('CNY', 'Yuan ya Uchina', 'CN¥', '¥', ['one' => 'yuan ya Uchina', 'other' => 'yuan za Uchina']),
    ...
    'GBP' => new C('GBP', 'Pauni ya Uingereza', '£', '£', ['one' => 'pauni ya Uingereza', 'other' => 'pauni za Uingereza']),
    ...
    'HKD' => new C('HKD', 'Dola ya Hong Kong', 'HK$', '$', ['one' => 'dola ya Hong Kong', 'other' => 'dola za Hong Kong']),
    ...
    'ILS' => new C('ILS', 'Shekeli Mpya ya Israel', '₪', '₪', ['one' => 'shekeli mpya ya Israel', 'other' => 'shekeli mpya za Israel']),
    'INR' => new C('INR', 'Rupia ya India', '₹', '₹', ['one' => 'rupia ya India', 'other' => 'rupia za India']),
    ...
    'JPY' => new C('JPY', 'Yen ya Japani', 'JP¥', '¥', ['one' => 'yen ya Japani', 'other' => 'yen za Japani'], 0),
    'KES' => new C('KES', 'Shilingi ya Kenya', 'Ksh', plurals: ['one' => 'shilingi ya Kenya', 'other' => 'shilingi za Kenya']),
    'KGS' => new C('KGS', 'Som ya Kyrgystan', narrow: '⃀', plurals: ['one' => 'som ya Kyrgystan', 'other' => 'som za Kyrgystan']),
    ...
    'KRW' => new C('KRW', 'Won ya Korea Kusini', '₩', '₩', ['one' => 'won ya Korea Kusini', 'other' => 'won za Korea Kusini'], 0),
    ...
    'LSL' => new C('LSL', 'Loti ya Lesoto', plurals: 'Loti za Lesoto'),
    ...
    'MXN' => new C('MXN', 'Peso ya Meksiko', 'MX$', '$', ['one' => 'peso ya Meksiko', 'other' => 'peso za Meksiko']),
    'MYR' => new C('MYR', 'Ringgit ya Malaysia', narrow: 'RM', plurals: ['one' => 'ringgit ya Malaysia', 'other' => 'ringgit za Malaysia']),
    'MZM' => new C('MZM', 'Metikali ya Msumbiji (1980–2006)', plurals: 'metikali ya Msumbiji (1980–2006)'),
    ...
    'NZD' => new C('NZD', 'Dola ya Nyuzilandi', 'NZ$', '$', ['one' => 'dola ya Nyuzilandi', 'other' => 'dola za Nyuzilandi']),
    'OMR' => new C('OMR', 'Rial ya Omani', plurals: ['one' => 'rial ya Omani', 'other' => 'rial za Omani'], minorUnits: 3),
    'PAB' => new C('PAB', 'Balboa ya Panama', plurals: 'balboa ya Panama'),
    ...
    'QAR' => new C('QAR', 'Rial ya Qatar', plurals: 'rial ya Qatar'),
    ...
    'SLE' => new C('SLE', 'Leone ya Siera Leoni', plurals: ['one' => 'leone ya Siera Leoni', 'other' => 'leone za Siera Leoni']),
    'SLL' => new C('SLL', 'Leone ya Siera Leoni (1964—2022)', plurals: ['one' => 'leone ya Siera Leoni (1964—2022)', 'other' => 'leone za Siera Leoni (1964—2022)']),
    ...
    'THB' => new C('THB', 'Baht ya Tailandi', '฿', '฿', ['one' => 'baht ya Tailandi', 'other' => 'baht za Tailandi']),
    ...
    'TWD' => new C('TWD', 'Dola ya Taiwan', 'NT$', 'NT$', ['one' => 'dola ya Taiwan', 'other' => 'dola za Taiwan']),
    ...
    'USD' => new C('USD', 'Dola ya Marekani', 'US$', '$', ['one' => 'dola ya Marekani', 'other' => 'dola za Marekani']),
    ...
    'VND' => new C('VND', 'Dong ya Vietnam', '₫', '₫', ['one' => 'dong ya Vietnam', 'other' => 'dong za Vietnam'], 0),
    ...
    'XCD' => new C('XCD', 'Dola ya Karibi Mashariki', 'EC$', '$', ['one' => 'dola ya Karibi Mashariki', 'other' => 'dola za Karibi Mashariki']),
