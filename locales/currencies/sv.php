...
return [
    ...
    'AED' => new C('AED', 'emiratisk dirham', plurals: 'emiratisk dirham'),
    'AFA' => new C('AFA', 'afghani (1927–2002)', plurals: 'afghani (1927–2002)'),
    ...
    'ANG' => new C('ANG', 'antillergulden', plurals: 'antillergulden'),
    ...
    'BGO' => new C('BGO', 'bulgarisk lev (1881–1952)', plurals: 'bulgarisk lev (1881–1952)'),
    ...
    'FJD' => new C('FJD', 'Fijidollar', narrow: '$', plurals: 'Fijidollar'),
    ...
    'GYD' => new C('GYD', 'Guyanadollar', narrow: '$', plurals: 'Guyanadollar'),
    'HKD' => new C('HKD', 'Hongkongdollar', narrow: '$', plurals: 'Hongkongdollar'),
    ...
    'SBD' => new C('SBD', 'Salomondollar', narrow: '$', plurals: 'Salomondollar'),
    ...
    'TTD' => new C('TTD', 'Trinidaddollar', narrow: '$', plurals: 'Trinidaddollar'),
    ...
    'USN' => new C('USN', 'US-dollar (nästa dag)', plurals: 'US-dollar (nästa dag)'),
    'USS' => new C('USS', 'US-dollar (samma dag)', plurals: 'US-dollar (samma dag)'),
    ...
    'UYW' => new C('UYW', 'uruguayansk indexenhet för nominell lön', plurals: 'uruguayansk indexenhet för nominell lön', minorUnits: 4),
    ...
    'XFU' => new C('XFU', 'internationella järnvägsunionens franc', plurals: 'internationella järnvägsunionens franc'),
    ...
    'ZWD' => new C('ZWD', 'Zimbabwe-dollar', plurals: 'Zimbabwe-dollar'),
    'ZWL' => new C('ZWL', 'Zimbabwe-dollar (2009)', plurals: 'Zimbabwe-dollar (2009)'),
    'ZWR' => new C('ZWR', 'Zimbabwe-dollar (2008)', plurals: 'Zimbabwe-dollar (2008)'),
];
