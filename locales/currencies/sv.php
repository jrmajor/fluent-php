...
return [
    ...
    'BBD' => new C('BBD', 'barbadisk dollar', 'Bds$', narrow: '$', plurals: ['one' => 'barbadisk dollar', 'other' => 'barbadiska dollar']),
    ...
    'BMD' => new C('BMD', 'bermudisk dollar', 'BM$', narrow: '$', plurals: ['one' => 'bermudisk dollar', 'other' => 'bermudiska dollar']),
    ...
    'JMD' => new C('JMD', 'jamaicansk dollar', 'JM$', narrow: '$', plurals: ['one' => 'Jamaica-dollar', 'other' => 'jamaicanska dollar']),
    ...
    'USD' => new C('USD', 'amerikansk dollar', 'US$', narrow: '$', plurals: ['one' => 'amerikansk dollar', 'other' => 'amerikanska dollar']),
