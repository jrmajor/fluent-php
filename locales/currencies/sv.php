...
return [
    ...
    'AED' => new C('AED', 'emiratisk dirham', plurals: ['other' => 'emiratisk dirham']),
    'AFA' => new C('AFA', 'afghani (1927–2002)', plurals: ['other' => 'afghani (1927–2002)']),
    ...
    'ANG' => new C('ANG', 'antillergulden', plurals: ['other' => 'antillergulden']),
    ...
    'BGO' => new C('BGO', 'bulgarisk lev (1881–1952)', plurals: ['other' => 'bulgarisk lev (1881–1952)']),
    ...
    'FJD' => new C('FJD', 'Fijidollar', narrow: '$', plurals: ['other' => 'Fijidollar']),
    ...
    'GYD' => new C('GYD', 'Guyanadollar', narrow: '$', plurals: ['other' => 'Guyanadollar']),
    'HKD' => new C('HKD', 'Hongkongdollar', narrow: '$', plurals: ['other' => 'Hongkongdollar']),
    ...
    'SBD' => new C('SBD', 'Salomondollar', narrow: '$', plurals: ['other' => 'Salomondollar']),
    ...
    'TTD' => new C('TTD', 'Trinidaddollar', narrow: '$', plurals: ['other' => 'Trinidaddollar']),
    ...
    'USN' => new C('USN', 'US-dollar (nästa dag)', plurals: ['other' => 'US-dollar (nästa dag)']),
    'USS' => new C('USS', 'US-dollar (samma dag)', plurals: ['other' => 'US-dollar (samma dag)']),
    ...
    'UYW' => new C('UYW', 'uruguayansk indexenhet för nominell lön', plurals: ['other' => 'uruguayansk indexenhet för nominell lön'], minorUnits: 4),
    ...
    'XFU' => new C('XFU', 'internationella järnvägsunionens franc', plurals: ['other' => 'internationella järnvägsunionens franc']),
    ...
    'ZWD' => new C('ZWD', 'Zimbabwe-dollar', plurals: ['other' => 'Zimbabwe-dollar']),
    'ZWL' => new C('ZWL', 'Zimbabwe-dollar (2009)', plurals: ['other' => 'Zimbabwe-dollar (2009)']),
    'ZWR' => new C('ZWR', 'Zimbabwe-dollar (2008)', plurals: ['other' => 'Zimbabwe-dollar (2008)']),
];
