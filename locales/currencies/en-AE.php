...
return [
    ...
    'BMD' => new C('BMD', 'Bermudan Dollar', plurals: ['one' => 'Bermudan dollar', 'other' => 'Bermudan dollars']),
    ...
    'PHP' => new C('PHP', 'Philippine Piso', '₱', plurals: ['one' => 'Philippine piso', 'other' => 'Philippine pisos']),
