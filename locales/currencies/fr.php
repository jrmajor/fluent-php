...
return [
    ...
    'AFN' => new C('AFN', 'afghani afghan', narrow: '؋', plurals: ['one' => 'afghani afghan', 'other' => 'afghanis afghan']),
    ...
    'AMD' => new C('AMD', 'dram arménien', narrow: '֏', plurals: ['one' => 'dram arménien', 'other' => 'drams arméniens']),
    'ANG' => new C('ANG', 'florin antillais', plurals: ['one' => 'florin antillais', 'other' => 'florins antillais']),
    'AOA' => new C('AOA', 'kwanza angolais', narrow: 'Kz', plurals: ['one' => 'kwanza angolais', 'other' => 'kwanzas angolais']),
    ...
    'ARS' => new C('ARS', 'peso argentin', '$AR', '$', ['one' => 'peso argentin', 'other' => 'pesos argentins']),
    'ATS' => new C('ATS', 'schilling autrichien', plurals: ['one' => 'schilling autrichien', 'other' => 'schillings autrichiens']),
    'AUD' => new C('AUD', 'dollar australien', '$AU', '$', ['one' => 'dollar australien', 'other' => 'dollars australiens']),
    ...
    'AZN' => new C('AZN', 'manat azéri', narrow: '₼', plurals: ['one' => 'manat azéri', 'other' => 'manats azéris']),
    'BAD' => new C('BAD', 'dinar bosniaque', plurals: ['one' => 'dinar bosniaque', 'other' => 'dinars bosniaques']),
    'BAM' => new C('BAM', 'mark convertible bosniaque', narrow: 'KM', plurals: ['one' => 'mark convertible bosniaque', 'other' => 'marks convertibles bosniaques']),
    'BBD' => new C('BBD', 'dollar barbadien', narrow: '$', plurals: ['one' => 'dollar barbadien', 'other' => 'dollars barbadiens']),
    'BDT' => new C('BDT', 'taka bangladeshi', narrow: '৳', plurals: ['one' => 'taka bangladeshi', 'other' => 'takas bangladeshis']),
    ...
    'BMD' => new C('BMD', 'dollar bermudien', '$BM', '$', ['one' => 'dollar bermudien', 'other' => 'dollars bermudiens']),
    'BND' => new C('BND', 'dollar brunéien', '$BN', '$', ['one' => 'dollar brunéien', 'other' => 'dollars brunéiens']),
    'BOB' => new C('BOB', 'boliviano bolivien', narrow: 'Bs', plurals: ['one' => 'boliviano bolivien', 'other' => 'bolivianos boliviens']),
    ...
    'BRL' => new C('BRL', 'réal brésilien', 'R$', 'R$', ['one' => 'réal brésilien', 'other' => 'réals brésiliens']),
    ...
    'BSD' => new C('BSD', 'dollar bahaméen', narrow: '$', plurals: ['one' => 'dollar bahaméen', 'other' => 'dollars bahaméens']),
    ...
    'BWP' => new C('BWP', 'pula botswanais', narrow: 'P', plurals: ['one' => 'pula botswanais', 'other' => 'pulas botswanais']),
    ...
    'BYN' => new C('BYN', 'rouble biélorusse', narrow: 'р.', plurals: ['one' => 'rouble biélorusse', 'other' => 'roubles biélorusses']),
    'BYR' => new C('BYR', 'rouble biélorusse (2000–2016)', plurals: ['one' => 'rouble biélorusse (2000–2016)', 'other' => 'roubles biélorusses (2000–2016)']),
    'BZD' => new C('BZD', 'dollar bélizéen', '$BZ', '$', ['one' => 'dollar bélizéen', 'other' => 'dollars bélizéens']),
    'CAD' => new C('CAD', 'dollar canadien', '$CA', '$', ['one' => 'dollar canadien', 'other' => 'dollars canadiens']),
    ...
    'CLP' => new C('CLP', 'peso chilien', '$CL', '$', ['one' => 'peso chilien', 'other' => 'pesos chiliens'], 0),
    ...
    'CNY' => new C('CNY', 'yuan renminbi chinois', narrow: '¥', plurals: ['one' => 'yuan renminbi chinois', 'other' => 'yuans renminbi chinois']),
    'COP' => new C('COP', 'peso colombien', '$CO', '$', ['one' => 'peso colombien', 'other' => 'pesos colombiens']),
    ...
    'CRC' => new C('CRC', 'colón costaricain', narrow: '₡', plurals: ['one' => 'colón costaricain', 'other' => 'colóns costaricains']),
    ...
    'CUC' => new C('CUC', 'peso cubain convertible', narrow: '$', plurals: ['one' => 'peso cubain convertible', 'other' => 'pesos cubains convertibles']),
    'CUP' => new C('CUP', 'peso cubain', narrow: '$', plurals: ['one' => 'peso cubain', 'other' => 'pesos cubains']),
    ...
    'CZK' => new C('CZK', 'couronne tchèque', narrow: 'Kč', plurals: ['one' => 'couronne tchèque', 'other' => 'couronnes tchèques']),
    ...
    'DKK' => new C('DKK', 'couronne danoise', narrow: 'kr', plurals: ['one' => 'couronne danoise', 'other' => 'couronnes danoises']),
    'DOP' => new C('DOP', 'peso dominicain', narrow: '$', plurals: ['one' => 'peso dominicain', 'other' => 'pesos dominicains']),
    ...
    'EGP' => new C('EGP', 'livre égyptienne', narrow: '£E', plurals: ['one' => 'livre égyptienne', 'other' => 'livres égyptiennes']),
    ...
    'ESP' => new C('ESP', 'peseta espagnole', narrow: '₧', plurals: ['one' => 'peseta espagnole', 'other' => 'pesetas espagnoles']),
    ...
    'FJD' => new C('FJD', 'dollar fidjien', '$FJ', '$', ['one' => 'dollar fidjien', 'other' => 'dollars fidjiens']),
    'FKP' => new C('FKP', 'livre des îles Malouines', '£FK', '£', ['one' => 'livre des îles Malouines', 'other' => 'livres des îles Malouines']),
    'FRF' => new C('FRF', 'franc français', 'F', plurals: ['one' => 'franc français', 'other' => 'francs français']),
    'GBP' => new C('GBP', 'livre sterling', '£GB', '£', ['one' => 'livre sterling', 'other' => 'livres sterling']),
    'GEK' => new C('GEK', 'coupon de lari géorgien', plurals: ['one' => 'coupon de lari géorgien', 'other' => 'coupons de lari géorgiens']),
    'GEL' => new C('GEL', 'lari géorgien', narrow: '₾', plurals: ['one' => 'lari géorgien', 'other' => 'lari géorgiens']),
    'GHC' => new C('GHC', 'cédi', plurals: ['one' => 'cédi ghanéen (1967–2007)', 'other' => 'cédis ghanéens (1967–2007)']),
    'GHS' => new C('GHS', 'cédi ghanéen', narrow: 'GH₵', plurals: ['one' => 'cédi ghanéen', 'other' => 'cédis ghanéens']),
    'GIP' => new C('GIP', 'livre de Gibraltar', '£GI', '£', ['one' => 'livre de Gibraltar', 'other' => 'livres de Gibraltar']),
    'GMD' => new C('GMD', 'dalasi gambien', plurals: ['one' => 'dalasi gambien', 'other' => 'dalasis gambiens']),
    'GNF' => new C('GNF', 'franc guinéen', narrow: 'FG', plurals: ['one' => 'franc guinéen', 'other' => 'francs guinéens'], minorUnits: 0),
    ...
    'GTQ' => new C('GTQ', 'quetzal guatémaltèque', narrow: 'Q', plurals: ['one' => 'quetzal guatémaltèque', 'other' => 'quetzals guatémaltèques']),
    ...
    'GYD' => new C('GYD', 'dollar du Guyana', narrow: '$', plurals: ['one' => 'dollar du Guyana', 'other' => 'dollars du Guyana']),
    'HKD' => new C('HKD', 'dollar de Hong Kong', narrow: '$', plurals: ['one' => 'dollar de Hong Kong', 'other' => 'dollars de Hong Kong']),
    'HNL' => new C('HNL', 'lempira hondurien', narrow: 'L', plurals: ['one' => 'lempira hondurien', 'other' => 'lempiras honduriens']),
    'HRD' => new C('HRD', 'dinar croate', plurals: ['one' => 'dinar croate', 'other' => 'dinars croates']),
    'HRK' => new C('HRK', 'kuna croate', narrow: 'kn', plurals: ['one' => 'kuna croate', 'other' => 'kunas croates']),
    'HTG' => new C('HTG', 'gourde haïtienne', plurals: ['one' => 'gourde haïtienne', 'other' => 'gourdes haïtiennes']),
    'HUF' => new C('HUF', 'forint hongrois', narrow: 'Ft', plurals: ['one' => 'forint hongrois', 'other' => 'forints hongrois']),
    'IDR' => new C('IDR', 'roupie indonésienne', narrow: 'Rp', plurals: ['one' => 'roupie indonésienne', 'other' => 'roupies indonésiennes']),
    ...
    'ILS' => new C('ILS', 'nouveau shekel israélien', '₪', '₪', ['one' => 'nouveau shekel israélien', 'other' => 'nouveaux shekels israéliens']),
    'INR' => new C('INR', 'roupie indienne', '₹', '₹', ['one' => 'roupie indienne', 'other' => 'roupies indiennes']),
    ...
    'ISK' => new C('ISK', 'couronne islandaise', narrow: 'kr', plurals: ['one' => 'couronne islandaise', 'other' => 'couronnes islandaises'], minorUnits: 0),
    'ITL' => new C('ITL', 'lire italienne', '₤IT', plurals: ['one' => 'lire italienne', 'other' => 'lires italiennes']),
    'JMD' => new C('JMD', 'dollar jamaïcain', narrow: '$', plurals: ['one' => 'dollar jamaïcain', 'other' => 'dollars jamaïcains']),
    ...
    'KGS' => new C('KGS', 'som kirghize', narrow: '⃀', plurals: ['one' => 'som kirghize', 'other' => 'soms kirghizes']),
    'KHR' => new C('KHR', 'riel cambodgien', narrow: '៛', plurals: ['one' => 'riel cambodgien', 'other' => 'riels cambodgiens']),
    'KMF' => new C('KMF', 'franc comorien', narrow: 'FC', plurals: ['one' => 'franc comorien', 'other' => 'francs comoriens'], minorUnits: 0),
    'KPW' => new C('KPW', 'won nord-coréen', narrow: '₩', plurals: ['one' => 'won nord-coréen', 'other' => 'wons nord-coréens']),
    'KRW' => new C('KRW', 'won sud-coréen', '₩', '₩', ['one' => 'won sud-coréen', 'other' => 'wons sud-coréens'], 0),
    ...
    'LBP' => new C('LBP', 'livre libanaise', '£LB', '£L', ['one' => 'livre libanaise', 'other' => 'livres libanaises']),
    ...
    'LTL' => new C('LTL', 'litas lituanien', narrow: 'Lt', plurals: ['one' => 'litas lituanien', 'other' => 'litas lituaniens']),
    ...
    'LVL' => new C('LVL', 'lats letton', narrow: 'Ls', plurals: ['one' => 'lats letton', 'other' => 'lats lettons']),
    ...
    'MGA' => new C('MGA', 'ariary malgache', narrow: 'Ar', plurals: ['one' => 'ariary malgache', 'other' => 'ariarys malgaches']),
    ...
    'MMK' => new C('MMK', 'kyat myanmarais', narrow: 'K', plurals: ['one' => 'kyat myanmarais', 'other' => 'kyats myanmarais']),
    'MNT' => new C('MNT', 'tugrik mongol', narrow: '₮', plurals: ['one' => 'tugrik mongol', 'other' => 'tugriks mongols']),
    ...
    'MUR' => new C('MUR', 'roupie mauricienne', narrow: 'Rs', plurals: ['one' => 'roupie mauricienne', 'other' => 'roupies mauriciennes']),
    'MVR' => new C('MVR', 'rufiyaa maldivienne', plurals: ['one' => 'rufiyaa maldivienne', 'other' => 'rufiyaas maldiviennes']),
    'MWK' => new C('MWK', 'kwacha malawite', plurals: ['one' => 'kwacha malawite', 'other' => 'kwachas malawites']),
    'MXN' => new C('MXN', 'peso mexicain', '$MX', '$', ['one' => 'peso mexicain', 'other' => 'pesos mexicains']),
    ...
    'MYR' => new C('MYR', 'ringgit malais', narrow: 'RM', plurals: ['one' => 'ringgit malais', 'other' => 'ringgits malais']),
    ...
    'NAD' => new C('NAD', 'dollar namibien', '$NA', '$', ['one' => 'dollar namibien', 'other' => 'dollars namibiens']),
    'NGN' => new C('NGN', 'naira nigérian', narrow: '₦', plurals: ['one' => 'naira nigérian', 'other' => 'nairas nigérians']),
    ...
    'NOK' => new C('NOK', 'couronne norvégienne', narrow: 'kr', plurals: ['one' => 'couronne norvégienne', 'other' => 'couronnes norvégiennes']),
    'NPR' => new C('NPR', 'roupie népalaise', narrow: 'Rs', plurals: ['one' => 'roupie népalaise', 'other' => 'roupies népalaises']),
    'NZD' => new C('NZD', 'dollar néo-zélandais', '$NZ', '$', ['one' => 'dollar néo-zélandais', 'other' => 'dollars néo-zélandais']),
    ...
    'PHP' => new C('PHP', 'peso philippin', narrow: '₱', plurals: ['one' => 'peso philippin', 'other' => 'pesos philippins']),
    'PKR' => new C('PKR', 'roupie pakistanaise', narrow: 'Rs', plurals: ['one' => 'roupie pakistanaise', 'other' => 'roupies pakistanaises']),
    'PLN' => new C('PLN', 'zloty polonais', narrow: 'zł', plurals: ['one' => 'zloty polonais', 'other' => 'zlotys polonais']),
    ...
    'PYG' => new C('PYG', 'guaraní paraguayen', narrow: '₲', plurals: ['one' => 'guaraní paraguayen', 'other' => 'guaranís paraguayens'], minorUnits: 0),
    ...
    'RON' => new C('RON', 'leu roumain', narrow: 'L', plurals: ['one' => 'leu roumain', 'other' => 'lei roumains']),
    'RSD' => new C('RSD', 'dinar serbe', plurals: ['one' => 'dinar serbe', 'other' => 'dinars serbes']),
    'RUB' => new C('RUB', 'rouble russe', narrow: '₽', plurals: ['one' => 'rouble russe', 'other' => 'roubles russes']),
    'RUR' => new C('RUR', 'rouble russe (1991–1998)', plurals: ['one' => 'rouble russe (1991–1998)', 'other' => 'roubles russes (1991–1998)']),
    'RWF' => new C('RWF', 'franc rwandais', narrow: 'FR', plurals: ['one' => 'franc rwandais', 'other' => 'francs rwandais'], minorUnits: 0),
    'SAR' => new C('SAR', 'riyal saoudien', plurals: ['one' => 'riyal saoudien', 'other' => 'riyals saoudiens']),
    'SBD' => new C('SBD', 'dollar des îles Salomon', '$SB', '$', ['one' => 'dollar des îles Salomon', 'other' => 'dollars des îles Salomon']),
    ...
    'SEK' => new C('SEK', 'couronne suédoise', narrow: 'kr', plurals: ['one' => 'couronne suédoise', 'other' => 'couronnes suédoises']),
    'SGD' => new C('SGD', 'dollar de Singapour', '$SG', '$', ['one' => 'dollar de Singapour', 'other' => 'dollars de Singapour']),
    'SHP' => new C('SHP', 'livre de Sainte-Hélène', narrow: '£', plurals: ['one' => 'livre de Sainte-Hélène', 'other' => 'livres de Sainte-Hélène']),
    ...
    'SLE' => new C('SLE', 'leone sierra-léonais', plurals: ['one' => 'leone sierra-léonais', 'other' => 'leones sierra-léonais']),
    'SLL' => new C('SLL', 'leone sierra-léonais (1964—2022)', plurals: ['one' => 'leone sierra-léonais (1964—2022)', 'other' => 'leones sierra-léonais (1964—2022)']),
    'SOS' => new C('SOS', 'shilling somalien', plurals: ['one' => 'shilling somalien', 'other' => 'shillings somaliens']),
    'SRD' => new C('SRD', 'dollar surinamais', '$SR', '$', ['one' => 'dollar surinamais', 'other' => 'dollars surinamais']),
    'SRG' => new C('SRG', 'florin surinamais', plurals: ['one' => 'florin surinamais', 'other' => 'florins surinamais']),
    'SSP' => new C('SSP', 'livre sud-soudanaise', narrow: '£', plurals: ['one' => 'livre sud-soudanaise', 'other' => 'livres sud-soudanaises']),
    'STD' => new C('STD', 'dobra santoméen (1977–2017)', plurals: ['one' => 'dobra santoméen (1977–2017)', 'other' => 'dobras santoméens (1977–2017)']),
    'STN' => new C('STN', 'dobra santoméen', narrow: 'Db', plurals: ['one' => 'dobra santoméen', 'other' => 'dobras santoméens']),
    ...
    'SYP' => new C('SYP', 'livre syrienne', narrow: '£', plurals: ['one' => 'livre syrienne', 'other' => 'livres syriennes']),
    'SZL' => new C('SZL', 'lilangeni swazi', plurals: ['one' => 'lilangeni swazi', 'other' => 'lilangenis swazis']),
    'THB' => new C('THB', 'baht thaïlandais', narrow: '฿', plurals: ['one' => 'baht thaïlandais', 'other' => 'bahts thaïlandais']),
    ...
    'TOP' => new C('TOP', 'pa’anga tongan', narrow: '$T', plurals: ['one' => 'pa’anga tongan', 'other' => 'pa’angas tongans']),
    ...
    'TRY' => new C('TRY', 'livre turque', narrow: '₺', plurals: ['one' => 'livre turque', 'other' => 'livres turques']),
    'TTD' => new C('TTD', 'dollar de Trinité-et-Tobago', '$TT', '$', ['one' => 'dollar de Trinité-et-Tobago', 'other' => 'dollars de Trinité-et-Tobago']),
    'TWD' => new C('TWD', 'nouveau dollar taïwanais', narrow: 'NT$', plurals: ['one' => 'nouveau dollar taïwanais', 'other' => 'nouveaux dollars taïwanais']),
    'TZS' => new C('TZS', 'shilling tanzanien', plurals: ['one' => 'shilling tanzanien', 'other' => 'shillings tanzaniens']),
    'UAH' => new C('UAH', 'hryvnia ukrainienne', narrow: '₴', plurals: ['one' => 'hryvnia ukrainienne', 'other' => 'hryvnias ukrainiennes']),
    ...
    'USD' => new C('USD', 'dollar des États-Unis', '$US', '$', ['one' => 'dollar des États-Unis', 'other' => 'dollars des États-Unis']),
    ...
    'UYU' => new C('UYU', 'peso uruguayen', '$UY', '$', ['one' => 'peso uruguayen', 'other' => 'pesos uruguayens']),
    'UZS' => new C('UZS', 'sum ouzbek', plurals: ['one' => 'sum ouzbek', 'other' => 'sums ouzbeks']),
    'VEB' => new C('VEB', 'bolivar vénézuélien (1871–2008)'),
    ...
    'VND' => new C('VND', 'dông vietnamien', '₫', '₫', ['one' => 'dông vietnamien', 'other' => 'dôngs vietnamiens'], 0),
    ...
    'XCD' => new C('XCD', 'dollar des Caraïbes orientales', narrow: '$', plurals: ['one' => 'dollar des Caraïbes orientales', 'other' => 'dollars des Caraïbes orientales']),
    'XCG' => new C('XCG', 'florin caribéen', 'Cg.', plurals: ['one' => 'florin caribéen', 'other' => 'florins caribéens']),
    ...
    'ZAR' => new C('ZAR', 'rand sud-africain', narrow: 'R', plurals: ['one' => 'rand sud-africain', 'other' => 'rands sud-africains']),
    'ZMK' => new C('ZMK', 'kwacha zambien (1968–2012)', plurals: ['one' => 'kwacha zambien (1968–2012)', 'other' => 'kwachas zambiens (1968–2012)']),
    'ZMW' => new C('ZMW', 'kwacha zambien', narrow: 'Kw', plurals: ['one' => 'kwacha zambien', 'other' => 'kwachas zambiens']),
