...
return [
    ...
    'ARS' => new C('ARS', 'peso argentin', '$AR', narrow: '$', plurals: ['one' => 'peso argentin', 'other' => 'pesos argentins']),
    'ATS' => new C('ATS', 'schilling autrichien', plurals: ['one' => 'schilling autrichien', 'other' => 'schillings autrichiens']),
    'AUD' => new C('AUD', 'dollar australien', '$AU', narrow: '$', plurals: ['one' => 'dollar australien', 'other' => 'dollars australiens']),
    ...
    'BMD' => new C('BMD', 'dollar bermudien', '$BM', narrow: '$', plurals: ['one' => 'dollar bermudien', 'other' => 'dollars bermudiens']),
    'BND' => new C('BND', 'dollar brunéien', '$BN', narrow: '$', plurals: ['one' => 'dollar brunéien', 'other' => 'dollars brunéiens']),
    ...
    'BRL' => new C('BRL', 'réal brésilien', 'R$', narrow: 'R$', plurals: ['one' => 'réal brésilien', 'other' => 'réals brésiliens']),
    ...
    'BZD' => new C('BZD', 'dollar bélizéen', '$BZ', narrow: '$', plurals: ['one' => 'dollar bélizéen', 'other' => 'dollars bélizéens']),
    ...
    'CLP' => new C('CLP', 'peso chilien', '$CL', narrow: '$', plurals: ['one' => 'peso chilien', 'other' => 'pesos chiliens'], minorUnits: 0),
    ...
    'COP' => new C('COP', 'peso colombien', '$CO', narrow: '$', plurals: ['one' => 'peso colombien', 'other' => 'pesos colombiens']),
    ...
    'FJD' => new C('FJD', 'dollar fidjien', '$FJ', narrow: '$', plurals: ['one' => 'dollar fidjien', 'other' => 'dollars fidjiens']),
    'FKP' => new C('FKP', 'livre des îles Malouines', '£FK', narrow: '£', plurals: ['one' => 'livre des îles Malouines', 'other' => 'livres des îles Malouines']),
    'FRF' => new C('FRF', 'franc français', 'F', plurals: ['one' => 'franc français', 'other' => 'francs français']),
    'GBP' => new C('GBP', 'livre sterling', '£GB', narrow: '£', plurals: ['one' => 'livre sterling', 'other' => 'livres sterling']),
    ...
    'GIP' => new C('GIP', 'livre de Gibraltar', '£GI', narrow: '£', plurals: ['one' => 'livre de Gibraltar', 'other' => 'livres de Gibraltar']),
    ...
    'MXN' => new C('MXN', 'peso mexicain', '$MX', narrow: '$', plurals: ['one' => 'peso mexicain', 'other' => 'pesos mexicains']),
    ...
    'NAD' => new C('NAD', 'dollar namibien', '$NA', narrow: '$', plurals: ['one' => 'dollar namibien', 'other' => 'dollars namibiens']),
    ...
    'NZD' => new C('NZD', 'dollar néo-zélandais', '$NZ', narrow: '$', plurals: ['one' => 'dollar néo-zélandais', 'other' => 'dollars néo-zélandais']),
    ...
    'SBD' => new C('SBD', 'dollar des îles Salomon', '$SB', narrow: '$', plurals: ['one' => 'dollar des îles Salomon', 'other' => 'dollars des îles Salomon']),
    ...
    'SGD' => new C('SGD', 'dollar de Singapour', '$SG', narrow: '$', plurals: ['one' => 'dollar de Singapour', 'other' => 'dollars de Singapour']),
    ...
    'SRD' => new C('SRD', 'dollar surinamais', '$SR', narrow: '$', plurals: ['one' => 'dollar surinamais', 'other' => 'dollars surinamais']),
    ...
    'TTD' => new C('TTD', 'dollar de Trinité-et-Tobago', '$TT', narrow: '$', plurals: ['one' => 'dollar de Trinité-et-Tobago', 'other' => 'dollars de Trinité-et-Tobago']),
    ...
    'USD' => new C('USD', 'dollar des États-Unis', '$US', narrow: '$', plurals: ['one' => 'dollar des États-Unis', 'other' => 'dollars des États-Unis']),
