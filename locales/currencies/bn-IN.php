...
return [
    ...
    'MXN' => new C('MXN', 'মেক্সিকান পেসো', 'MX$', narrow: '$', plurals: 'মেক্সিকান পেসো'),
    'USD' => new C('USD', 'মার্কিন ডলার', '$', narrow: '$', plurals: 'মার্কিন ডলার'),
    'XCD' => new C('XCD', 'পূর্ব ক্যারিবিয়ান ডলার', 'EC$', narrow: '$', plurals: 'পূর্ব ক্যারিবিয়ান ডলার'),
];
