...
return [
    ...
    'AFA' => new C('AFA', 'افغانۍ (1927–2002)', plurals: ['other' => 'افغانۍ (1927–2002)']),
    'AFN' => new C('AFN', 'افغانۍ', '؋', narrow: '؋', plurals: ['other' => 'افغانۍ']),
    ...
    'AWG' => new C('AWG', 'اروبايي فلورن', plurals: ['other' => 'اروبايي فلورن']),
    ...
    'BOB' => new C('BOB', 'بوليوي بوليويانو', narrow: 'Bs', plurals: ['other' => 'بوليوي بوليويانو']),
    ...
    'CNH' => new C('CNH', 'چيني يوان (آف شور)', plurals: ['other' => 'چيني يوان (آف شور)']),
    'CNY' => new C('CNY', 'چيني يوان', 'CN¥', narrow: '¥', plurals: ['other' => 'چيني يوان']),
    ...
    'INR' => new C('INR', 'هندي روپۍ', '₹', narrow: '₹', plurals: ['other' => 'هندي روپۍ']),
    ...
    'JPY' => new C('JPY', 'جاپاني ين', 'JP¥', narrow: '¥', plurals: ['other' => 'جاپاني ين'], minorUnits: 0),
    ...
    'KPW' => new C('KPW', 'شمالي کوريايي وان', narrow: '₩', plurals: ['other' => 'شمالي کوريايي وان']),
    'KRW' => new C('KRW', 'جنوبي کوريايي وان', '₩', narrow: '₩', plurals: ['other' => 'جنوبي کوريايي وان'], minorUnits: 0),
    ...
    'LKR' => new C('LKR', 'سري لنکن روپۍ', narrow: 'Rs', plurals: ['other' => 'سري لنکن روپۍ']),
    ...
    'MUR' => new C('MUR', 'موريشيسي روپۍ', narrow: 'Rs', plurals: ['other' => 'موريشيسي روپۍ']),
    'MVR' => new C('MVR', 'مالديپي روپيا', plurals: ['other' => 'مالديپي روپيا']),
    ...
    'NPR' => new C('NPR', 'نيپالي روپۍ', narrow: 'Rs', plurals: ['other' => 'نيپالي روپۍ']),
    ...
    'PGK' => new C('PGK', 'پاپوا نيوګاني کينا', plurals: ['other' => 'پاپوا نيوګاني کينا']),
    ...
    'PYG' => new C('PYG', 'پيراګوين ګوراني', narrow: '₲', plurals: ['other' => 'پيراګوين ګوراني'], minorUnits: 0),
    ...
    'SCR' => new C('SCR', 'سيچيليسي روپۍ', plurals: ['other' => 'سيچيليسي روپۍ']),
    ...
    'UZS' => new C('UZS', 'ازبکستاني سوم', plurals: ['other' => 'ازبکستاني سوم']),
    'VES' => new C('VES', 'وينزويلي بوليوار', plurals: ['one' => 'وينزويلي بوليوار', 'other' => 'وينزويلي بوليوارز']),
    'VND' => new C('VND', 'ويتنامي ډونګ', '₫', narrow: '₫', plurals: ['other' => 'ويتنامي ډونګ'], minorUnits: 0),
    'VUV' => new C('VUV', 'ونواتو واتو', plurals: ['one' => 'ونواتو واتو', 'other' => 'ونواتو واتوس'], minorUnits: 0),
    'WST' => new C('WST', 'سموون تالا', plurals: ['other' => 'سموون تالا']),
    ...
    'ZAR' => new C('ZAR', 'جنوبي افريقاېي رنډ', narrow: 'R', plurals: ['other' => 'جنوبي افريقاېي رنډ']),
