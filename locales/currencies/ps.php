...
return [
    ...
    'AUD' => new C('AUD', 'آسترالوي ډالر', 'A$', '$', ['one' => 'آسترالوي ډالر', 'other' => 'آسترالوي ډالرې']),
    ...
    'BRL' => new C('BRL', 'برازيلي ريل', 'R$', 'R$', ['one' => 'برازيلي ريل', 'other' => 'برازيلي ريلز']),
    ...
    'CAD' => new C('CAD', 'کاناډايي ډالر', 'CA$', '$', ['one' => 'کاناډايي ډالر', 'other' => 'کاناډايي ډالرې']),
    ...
    'CNY' => new C('CNY', 'چيني يوان', 'CN¥', '¥', 'چيني يوان'),
    ...
    'EUR' => new C('EUR', 'يورو', '€', '€', ['one' => 'يورو', 'other' => 'يوروز']),
    ...
    'GBP' => new C('GBP', 'برتانوې پونډ', '£', '£', ['one' => 'برتانوې پونډ', 'other' => 'برتانوې پونډونه']),
    ...
    'HKD' => new C('HKD', 'هانګ کانګ ډالر', 'HK$', '$', ['one' => 'هانګ کانګ ډالر', 'other' => 'هانګ کانګ ډالرې']),
    ...
    'ILS' => new C('ILS', 'اسرايلي نيو شيکل', '₪', '₪', ['one' => 'اسرايلي نيو شيکل', 'other' => 'اسرايلي نيو شيکلز']),
    'INR' => new C('INR', 'هندي روپۍ', '₹', '₹', 'هندي روپۍ'),
    ...
    'JPY' => new C('JPY', 'جاپاني ين', 'JP¥', '¥', 'جاپاني ين', 0),
    ...
    'KRW' => new C('KRW', 'جنوبي کوريايي وان', '₩', '₩', 'جنوبي کوريايي وان', 0),
    ...
    'MXN' => new C('MXN', 'ميکسيکن پيسو', 'MX$', '$', ['one' => 'ميکسيکن پيسو', 'other' => 'ميکسيکن پيسوز']),
    ...
    'NZD' => new C('NZD', 'نيوزي لينډي ډالر', 'NZ$', '$', ['one' => 'نيوزي لينډي ډالر', 'other' => 'نيوزي لينډي ډالرې']),
    ...
    'PHP' => new C('PHP', 'فلپاينۍ پیسو', '₱', '₱', ['one' => 'فلپاينۍ پیسو', 'other' => 'فلپاينۍ پیسوز']),
    ...
    'TWD' => new C('TWD', 'نيو تائيواني ډالر', 'NT$', '$', ['one' => 'نيو تائيواني ډالر', 'other' => 'نيو تائيواني ډالرې']),
    ...
    'USD' => new C('USD', 'امريکايي ډالر', '$', '$', ['one' => 'امريکايي ډالر', 'other' => 'امريکايي ډالرې']),
    ...
    'VND' => new C('VND', 'ويتنامي ډونګ', '₫', '₫', 'ويتنامي ډونګ', 0),
    ...
    'XCD' => new C('XCD', 'ختيځ کربين ډالر', 'EC$', '$', ['one' => 'ختيځ کربين ډالر', 'other' => 'ختيځ کربين ډالرې']),
