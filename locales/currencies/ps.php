...
return [
    ...
    'SSP' => new C('SSP', 'جنوب سوډاني پونډ', narrow: '£', plurals: ['one' => 'جنوب سوډاني پونډ', 'other' => 'جنوب سوډاني پونډ']),
    'STN' => new C('STN', 'ساو ټوم او پرينسپي ډوبرا', narrow: 'Db', plurals: ['one' => 'ساو ټوم او پرينسپي ډوبرا', 'other' => 'ساو ټوم او پرينسپي ډوبراس']),
    'SYP' => new C('SYP', 'سوريايي پونډ', narrow: '£', plurals: ['one' => 'سوريايي پونډ', 'other' => 'سوريايي پونډ']),
    'SZL' => new C('SZL', 'سوازي ليلانګيني', plurals: ['one' => 'سوازي ليلانګيني', 'other' => 'سوازي ايمالانګيني']),
    'THB' => new C('THB', 'تهايي بات', narrow: '฿', plurals: ['one' => 'تهايي بات', 'other' => 'تهايي بات']),
