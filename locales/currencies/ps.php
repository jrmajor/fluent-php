...
return [
    ...
    'AFA' => new C('AFA', 'افغانۍ (1927–2002)'),
    'AFN' => new C('AFN', 'افغانۍ', '؋', '؋'),
    ...
    'BOB' => new C('BOB', 'بوليوي بوليويانو', narrow: 'Bs'),
    ...
    'CNH' => new C('CNH', 'چيني يوان (آف شور)'),
    'CNY' => new C('CNY', 'چيني يوان', 'CN¥', '¥'),
    ...
    'JPY' => new C('JPY', 'جاپاني ين', 'JP¥', '¥', minorUnits: 0),
    'KES' => new C('KES', 'کينيايي شيلنګ', plurals: ['one' => 'کينيايي شيلنګ', 'other' => 'کينيايي شيلنګز']),
    'KGS' => new C('KGS', 'کرغزستاني سوم', narrow: '⃀', plurals: ['one' => 'کرغزستاني سوم', 'other' => 'کرغزستاني سومز']),
    ...
    'KPW' => new C('KPW', 'شمالي کوريايي وان', narrow: '₩'),
    'KRW' => new C('KRW', 'جنوبي کوريايي وان', '₩', '₩', minorUnits: 0),
    ...
    'LKR' => new C('LKR', 'سري لنکن روپۍ', narrow: 'Rs'),
    ...
    'MUR' => new C('MUR', 'موريشيسي روپۍ', narrow: 'Rs'),
    'MVR' => new C('MVR', 'مالديپي روپيا'),
    ...
    'NPR' => new C('NPR', 'نيپالي روپۍ', narrow: 'Rs'),
    ...
    'PGK' => new C('PGK', 'پاپوا نيوګاني کينا'),
    ...
    'PYG' => new C('PYG', 'پيراګوين ګوراني', narrow: '₲', minorUnits: 0),
    ...
    'SLE' => new C('SLE', 'سيرا ليوني ليون', plurals: ['one' => 'سيرا ليوني ليون', 'other' => 'سيرا ليوني ليونونه']),
    'SLL' => new C('SLL', 'سيرا ليوني ليون - 1964-2022', plurals: ['one' => 'سيرا ليوني ليون - 1964-2022', 'other' => 'سيرا ليوني ليونونه - 1964-2022']),
    ...
    'ZAR' => new C('ZAR', 'جنوبي افريقاېي رنډ', narrow: 'R'),
