...
return [
    ...
    'CNY' => new C('CNY', 'Yuwanta Shiinaha', 'CN¥', narrow: '¥', plurals: 'yuwanta Shiinaha'),
    ...
    'EUR' => new C('EUR', 'Yuuroo', '€', narrow: '€', plurals: 'yuuroo'),
    ...
    'GBP' => new C('GBP', 'Bowndka Biritishka', '£', narrow: '£', plurals: 'Bowndka Biritishka'),
    ...
    'HKD' => new C('HKD', 'Doolarka Hoon Koon', 'HK$', narrow: '$', plurals: 'Doolarada Hoon Koon'),
    ...
    'ILS' => new C('ILS', 'Niyuu Shekelka Israaiil', '₪', narrow: '₪', plurals: 'niyuu shekelka Israaiil'),
    'INR' => new C('INR', 'Rubiga Hindiya', '₹', narrow: '₹', plurals: 'rubiga Hindiya'),
    ...
    'JPY' => new C('JPY', 'Yenta Jabaan', 'JP¥', narrow: '¥', plurals: 'yenta Jabaan', minorUnits: 0),
    ...
    'KRW' => new C('KRW', 'Wonka Koonfur Kuuriya', '₩', narrow: '₩', plurals: 'wonka Koonfur Kuuriya', minorUnits: 0),
    ...
    'PHP' => new C('PHP', 'Biso Filibin', '₱', narrow: '₱', plurals: 'biso Filibin'),
    ...
    'VND' => new C('VND', 'Dongta Fitnaam', '₫', narrow: '₫', plurals: 'dongta Fitnaam', minorUnits: 0),
