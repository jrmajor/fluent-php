...
return [
    ...
    'AFN' => new C('AFN', 'afghansk afghani', plurals: ['one' => 'afghansk afghani', 'other' => 'afghanska afghani']),
    ...
    'AMD' => new C('AMD', 'armenisk dram', plurals: ['one' => 'armenisk dram', 'other' => 'armeniska dram']),
    'ANG' => new C('ANG', 'Antillergulden', plurals: ['one' => 'Antillergulden', 'other' => 'Antillergulden']),
    'AOA' => new C('AOA', 'angolansk kwanza', plurals: ['one' => 'angolansk kwanza', 'other' => 'angolanska kwanza']),
    ...
    'ARS' => new C('ARS', 'argentinsk peso', plurals: ['one' => 'argentinsk peso', 'other' => 'argentinska pesos']),
    'ATS' => new C('ATS', 'österrikisk schilling', plurals: ['one' => 'österrikisk schilling', 'other' => 'österrikiska schilling']),
    'AUD' => new C('AUD', 'australisk dollar', plurals: ['one' => 'australisk dollar', 'other' => 'australiska dollar']),
    ...
    'AZN' => new C('AZN', 'azerbajdzjansk manat', plurals: ['one' => 'azerbajdzjansk manat', 'other' => 'azerbajdzjanska manat']),
    ...
    'BAM' => new C('BAM', 'bosnisk-hercegovinsk mark (konvertibel)', plurals: ['one' => 'bosnisk-hercegovinsk mark (konvertibel)', 'other' => 'bosnisk-hercegovinska mark (konvertibla)']),
    ...
    'BBD' => new C('BBD', 'barbadisk dollar', 'Bds$', plurals: ['one' => 'barbadisk dollar', 'other' => 'barbadisk dollar']),
    'BDT' => new C('BDT', 'bangladeshisk taka', plurals: ['one' => 'bangladeshisk taka', 'other' => 'bangladeshiska taka']),
    ...
    'BMD' => new C('BMD', 'bermudisk dollar', 'BM$', plurals: ['one' => 'bermudisk dollar', 'other' => 'bermudisk dollar']),
    'BND' => new C('BND', 'bruneisk dollar', plurals: ['one' => 'bruneisk dollar', 'other' => 'bruneiska dollar']),
    'BOB' => new C('BOB', 'boliviansk boliviano', plurals: ['one' => 'boliviansk boliviano', 'other' => 'bolivianska bolivianos']),
    ...
    'BRL' => new C('BRL', 'brasiliansk real', 'BR$', plurals: ['one' => 'brasiliansk real', 'other' => 'brasilianska real']),
    ...
    'BSD' => new C('BSD', 'bahamansk dollar', 'BS$', plurals: ['one' => 'bahamansk dollar', 'other' => 'bahamanska dollar']),
    ...
    'BWP' => new C('BWP', 'botswansk pula', plurals: ['one' => 'botswansk pula', 'other' => 'botswanska pula']),
    'BYB' => new C('BYB', 'vitrysk ny rubel (1994–1999)', plurals: ['one' => 'vitrysk rubel (1994–1999)', 'other' => 'vitryska nya rubel (1994–1999)']),
    'BYN' => new C('BYN', 'vitrysk rubel', plurals: ['one' => 'vitrysk rubel', 'other' => 'vitryska rubel']),
    'BYR' => new C('BYR', 'vitrysk rubel (2000–2016)', plurals: ['one' => 'vitrysk rubel (2000–2016)', 'other' => 'vitryska rubel (2000–2016)']),
    'BZD' => new C('BZD', 'belizisk dollar', 'BZ$', plurals: ['one' => 'belizisk dollar', 'other' => 'beliziska dollar']),
    'CAD' => new C('CAD', 'kanadensisk dollar', 'CA$', plurals: ['one' => 'kanadensisk dollar', 'other' => 'kanadensiska dollar']),
    ...
    'CLP' => new C('CLP', 'chilensk peso', plurals: ['one' => 'chilensk peso', 'other' => 'chilenska pesos'], minorUnits: 0),
    ...
    'CNY' => new C('CNY', 'kinesisk yuan', plurals: ['one' => 'kinesisk yuan', 'other' => 'kinesiska yuan']),
    'COP' => new C('COP', 'colombiansk peso', plurals: ['one' => 'colombiansk peso', 'other' => 'colombianska pesos']),
    ...
    'CRC' => new C('CRC', 'costarikansk colón', plurals: ['one' => 'costarikansk colón', 'other' => 'costarikanska colón']),
    ...
    'CUC' => new C('CUC', 'kubansk peso (konvertibel)', plurals: ['one' => 'kubansk peso (konvertibel)', 'other' => 'kubanska pesos (konvertibla)']),
    'CUP' => new C('CUP', 'kubansk peso', plurals: ['one' => 'kubansk peso', 'other' => 'kubanska pesos']),
    ...
    'CZK' => new C('CZK', 'tjeckisk koruna', plurals: ['one' => 'tjeckisk koruna', 'other' => 'tjeckiska koruna']),
    ...
    'DKK' => new C('DKK', 'dansk krona', 'Dkr', plurals: ['one' => 'dansk krona', 'other' => 'danska kronor']),
    'DOP' => new C('DOP', 'dominikansk peso', 'RD$', plurals: ['one' => 'dominikansk peso', 'other' => 'dominikanska pesos']),
    ...
    'EGP' => new C('EGP', 'egyptiskt pund', 'EG£', plurals: ['one' => 'egyptiskt pund', 'other' => 'egyptiska pund']),
    ...
    'FJD' => new C('FJD', 'Fijidollar', plurals: ['one' => 'Fijidollar', 'other' => 'Fijidollar']),
    ...
    'GBP' => new C('GBP', 'brittiskt pund', plurals: ['one' => 'brittiskt pund', 'other' => 'brittiska pund']),
    'GEK' => new C('GEK', 'georgisk kupon larit', plurals: ['one' => 'georgisk kupon larit', 'other' => 'georgiska kupon larit']),
    'GEL' => new C('GEL', 'georgisk lari', plurals: ['one' => 'georgisk lari', 'other' => 'georgiska lari']),
    'GHC' => new C('GHC', 'ghanansk cedi (1979–2007)', plurals: ['one' => 'ghanansk cedi (1979–2007)', 'other' => 'ghananska cedi (1979–2007)']),
    'GHS' => new C('GHS', 'ghanansk cedi', plurals: ['one' => 'ghanansk cedi', 'other' => 'ghananska cedi']),
    'GIP' => new C('GIP', 'gibraltiskt pund', plurals: ['one' => 'gibraltiskt pund', 'other' => 'gibraltiska pund']),
    'GMD' => new C('GMD', 'gambisk dalasi', plurals: ['one' => 'gambisk dalasi', 'other' => 'gambiska dalasi']),
    'GNF' => new C('GNF', 'guineansk franc', plurals: ['one' => 'guineansk franc', 'other' => 'guineanska franc'], minorUnits: 0),
    ...
    'GTQ' => new C('GTQ', 'guatemalansk quetzal', plurals: ['one' => 'guatemalansk quetzal', 'other' => 'guatemalanska quetzal']),
    ...
    'GYD' => new C('GYD', 'Guyanadollar', plurals: ['one' => 'Guyanadollar', 'other' => 'Guyanadollar']),
    'HKD' => new C('HKD', 'Hongkongdollar', plurals: ['one' => 'Hongkongdollar', 'other' => 'Hongkongdollar']),
    'HNL' => new C('HNL', 'honduransk lempira', plurals: ['one' => 'honduransk lempira', 'other' => 'honduranska lempira']),
    'HRD' => new C('HRD', 'kroatisk dinar', plurals: ['one' => 'kroatisk dinar', 'other' => 'kroatiska dinarer']),
    'HRK' => new C('HRK', 'kroatisk kuna', plurals: ['one' => 'kroatisk kuna', 'other' => 'kroatiska kunor']),
    'HTG' => new C('HTG', 'haitisk gourde', plurals: ['one' => 'haitisk gourde', 'other' => 'haitiska gourder']),
    'HUF' => new C('HUF', 'ungersk forint', plurals: ['one' => 'ungersk forint', 'other' => 'ungerska forinter']),
    'IDR' => new C('IDR', 'indonesisk rupie', plurals: ['one' => 'indonesisk rupie', 'other' => 'indonesiska rupier']),
    ...
    'ILS' => new C('ILS', 'israelisk ny shekel', '₪', plurals: ['one' => 'israelisk ny shekel', 'other' => 'israeliska nya shekel']),
    'INR' => new C('INR', 'indisk rupie', plurals: ['one' => 'indisk rupie', 'other' => 'indiska rupier']),
    ...
    'ISK' => new C('ISK', 'isländsk krona', 'Ikr', plurals: ['one' => 'isländsk krona', 'other' => 'isländska kronor'], minorUnits: 0),
    'ITL' => new C('ITL', 'italiensk lire', plurals: ['one' => 'italiensk lire', 'other' => 'italienska lire']),
    'JMD' => new C('JMD', 'jamaicansk dollar', 'JM$', plurals: ['one' => 'Jamaica-dollar', 'other' => 'jamaicansk dollar']),
    'JOD' => new C('JOD', 'jordansk dinar', plurals: ['one' => 'jordansk dinar', 'other' => 'jordanska dinarer'], minorUnits: 3),
    'JPY' => new C('JPY', 'japansk yen', plurals: ['one' => 'japansk yen', 'other' => 'japanska yen'], minorUnits: 0),
    ...
    'KHR' => new C('KHR', 'kambodjansk riel', plurals: ['one' => 'kambodjansk riel', 'other' => 'kambodjanska riel']),
    'KMF' => new C('KMF', 'komorisk franc', plurals: ['one' => 'komorisk franc', 'other' => 'komoriska franc'], minorUnits: 0),
    'KPW' => new C('KPW', 'nordkoreansk won', plurals: ['one' => 'nordkoreansk won', 'other' => 'nordkoreanska won']),
    ...
    'KRW' => new C('KRW', 'sydkoreansk won', plurals: ['one' => 'sydkoreansk won', 'other' => 'sydkoreanska won'], minorUnits: 0),
    'KWD' => new C('KWD', 'kuwaitisk dinar', plurals: ['one' => 'kuwaitisk dinar', 'other' => 'kuwaitiska dinarer'], minorUnits: 3),
    'KYD' => new C('KYD', 'caymansk dollar', plurals: ['one' => 'caymansk dollar', 'other' => 'caymansk dollar']),
    'KZT' => new C('KZT', 'kazakisk tenge', plurals: ['one' => 'kazakisk tenge', 'other' => 'kazakiska tenge']),
    'LAK' => new C('LAK', 'laotisk kip', plurals: ['one' => 'laotisk kip', 'other' => 'laotiska kip']),
    'LBP' => new C('LBP', 'libanesiskt pund', plurals: ['one' => 'libanesiskt pund', 'other' => 'libanesiska pund']),
    'LKR' => new C('LKR', 'srilankesisk rupie', plurals: ['one' => 'srilankesisk rupie', 'other' => 'srilankesiska rupier']),
    'LRD' => new C('LRD', 'liberiansk dollar', plurals: ['one' => 'liberiansk dollar', 'other' => 'liberianska dollar']),
    'LSL' => new C('LSL', 'lesothisk loti', plurals: ['one' => 'lesothisk loti', 'other' => 'lesothiska lotier']),
    'LTL' => new C('LTL', 'litauisk litas', plurals: ['one' => 'litauisk litas', 'other' => 'litauiska litai']),
    ...
    'LVL' => new C('LVL', 'lettisk lats', plurals: ['one' => 'lettisk lats', 'other' => 'lettiska lati']),
    ...
    'MGA' => new C('MGA', 'madagaskisk ariary', plurals: ['one' => 'madagaskisk ariary', 'other' => 'madagaskiska ariary']),
    ...
    'MMK' => new C('MMK', 'myanmarisk kyat', plurals: ['one' => 'myanmarisk kyat', 'other' => 'myanmariska kyat']),
    'MNT' => new C('MNT', 'mongolisk tögrög', plurals: ['one' => 'mongolisk tögrög', 'other' => 'mongoliska tögrög']),
    ...
    'MUR' => new C('MUR', 'mauritisk rupie', plurals: ['one' => 'mauritisk rupie', 'other' => 'mauritiska rupier']),
    ...
    'MXN' => new C('MXN', 'mexikansk peso', 'MX$', plurals: ['one' => 'mexikansk peso', 'other' => 'mexikanska pesos']),
    ...
    'MYR' => new C('MYR', 'malaysisk ringgit', plurals: ['one' => 'malaysisk ringgit', 'other' => 'malaysiska ringgiter']),
    ...
    'NAD' => new C('NAD', 'namibisk dollar', plurals: ['one' => 'namibisk dollar', 'other' => 'namibiska dollar']),
    'NGN' => new C('NGN', 'nigeriansk naira', plurals: ['one' => 'nigeriansk naira', 'other' => 'nigerianska naira']),
    ...
    'NIO' => new C('NIO', 'nicaraguansk córdoba', plurals: ['one' => 'nicaraguansk córdoba', 'other' => 'nicaraguanska córdobas']),
    'NLG' => new C('NLG', 'nederländsk gulden', plurals: ['one' => 'nederländsk gulden', 'other' => 'nederländska gulden']),
    'NOK' => new C('NOK', 'norsk krona', 'Nkr', plurals: ['one' => 'norsk krona', 'other' => 'norska kronor']),
    'NPR' => new C('NPR', 'nepalesisk rupie', plurals: ['one' => 'nepalesisk rupie', 'other' => 'nepalesiska rupier']),
    'NZD' => new C('NZD', 'nyzeeländsk dollar', plurals: ['one' => 'nyzeeländsk dollar', 'other' => 'nyzeeländska dollar']),
    ...
    'PHP' => new C('PHP', 'filippinsk peso', plurals: ['one' => 'filippinsk peso', 'other' => 'filippinska pesos']),
    'PKR' => new C('PKR', 'pakistansk rupie', plurals: ['one' => 'pakistansk rupie', 'other' => 'pakistanska rupier']),
    'PLN' => new C('PLN', 'polsk zloty', plurals: ['one' => 'polsk zloty', 'other' => 'polska zloty']),
    ...
    'PYG' => new C('PYG', 'paraguayansk guarani', plurals: ['one' => 'paraguayansk guarani', 'other' => 'paraguayska guarani'], minorUnits: 0),
    ...
    'RON' => new C('RON', 'rumänsk leu', plurals: ['one' => 'rumänsk leu', 'other' => 'rumänska lei']),
    'RSD' => new C('RSD', 'serbisk dinar', plurals: ['one' => 'serbisk dinar', 'other' => 'serbiska dinarer']),
    'RUB' => new C('RUB', 'rysk rubel', plurals: ['one' => 'rysk rubel', 'other' => 'ryska rubel']),
    'RUR' => new C('RUR', 'rysk rubel (1991–1998)', plurals: ['one' => 'rysk rubel (1991–1998)', 'other' => 'ryska rubel (1991–1998)']),
    'RWF' => new C('RWF', 'rwandisk franc', plurals: ['one' => 'rwandisk franc', 'other' => 'rwandiska franc'], minorUnits: 0),
    'SAR' => new C('SAR', 'saudisk riyal', plurals: ['one' => 'saudisk riyal', 'other' => 'saudiska riyal']),
    'SBD' => new C('SBD', 'Salomondollar', plurals: ['one' => 'Salomondollar', 'other' => 'Salomondollar']),
    ...
    'SEK' => new C('SEK', 'svensk krona', 'kr', plurals: ['one' => 'svensk krona', 'other' => 'svenska kronor']),
    'SGD' => new C('SGD', 'singaporiansk dollar', plurals: ['one' => 'singaporiansk dollar', 'other' => 'singaporianska dollar']),
    'SHP' => new C('SHP', 'sankthelenskt pund', plurals: ['one' => 'sankthelenskt pund', 'other' => 'sankthelenskt pund']),
    ...
    'SRD' => new C('SRD', 'surinamesisk dollar', plurals: ['one' => 'surinamesisk dollar', 'other' => 'surinamesiska dollar']),
    'SRG' => new C('SRG', 'surinamesisk gulden', plurals: ['one' => 'surinamesisk gulden', 'other' => 'surinamesiska gulden']),
    'SSP' => new C('SSP', 'sydsudanesiskt pund', plurals: ['one' => 'sydsudanesiskt pund', 'other' => 'sydsudanesiska pund']),
    'STD' => new C('STD', 'saotomeansk dobra (1977–2017)', plurals: ['one' => 'saotomeansk dobra (1977–2017)', 'other' => 'saotomeanska dobra (1977–2017)']),
    'STN' => new C('STN', 'saotomeansk dobra', plurals: ['one' => 'saotomeansk dobra', 'other' => 'saotomeanska dobra']),
    ...
    'SYP' => new C('SYP', 'syriskt pund', plurals: ['one' => 'syriskt pund', 'other' => 'syriska pund']),
    'SZL' => new C('SZL', 'swaziländsk lilangeni', plurals: ['one' => 'swaziländsk lilangeni', 'other' => 'swaziländska lilangeni']),
    'THB' => new C('THB', 'thailändsk baht', plurals: ['one' => 'thailändsk baht', 'other' => 'thailändska baht']),
    ...
    'TOP' => new C('TOP', 'tongansk paʻanga', plurals: ['one' => 'tongansk paʻanga', 'other' => 'tonganska paʻanga']),
    ...
    'TRY' => new C('TRY', 'turkisk lira', plurals: ['one' => 'turkisk lira', 'other' => 'turkiska lira']),
    'TTD' => new C('TTD', 'Trinidaddollar', plurals: ['one' => 'Trinidaddollar', 'other' => 'Trinidaddollar']),
    'TWD' => new C('TWD', 'taiwanesisk dollar', plurals: ['one' => 'taiwanesisk dollar', 'other' => 'taiwanesisk dollar']),
    'TZS' => new C('TZS', 'tanzanisk shilling', plurals: ['one' => 'tanzanisk shilling', 'other' => 'tanzaniska shilling']),
    'UAH' => new C('UAH', 'ukrainsk hryvnia', plurals: ['one' => 'ukrainsk hryvnia', 'other' => 'ukrainska hryvnia']),
    ...
    'USD' => new C('USD', 'amerikansk dollar', 'US$', plurals: ['one' => 'amerikansk dollar', 'other' => 'amerikansk dollar']),
    ...
    'UYU' => new C('UYU', 'uruguayansk peso', plurals: ['one' => 'uruguayansk peso', 'other' => 'uruguayanska pesos']),
    ...
    'VEF' => new C('VEF', 'venezuelansk bolívar (2008–2018)', plurals: ['one' => 'venezuelansk bolívar (2008–2018)', 'other' => 'venezuelanska bolívar (2008–2018)']),
    'VES' => new C('VES', 'venezuelansk bolívar', plurals: ['one' => 'venezuelansk bolívar', 'other' => 'venezuelanska bolívar']),
    'VND' => new C('VND', 'vietnamesisk dong', plurals: ['one' => 'vietnamesisk dong', 'other' => 'vietnamesiska dong'], minorUnits: 0),
    ...
    'XCD' => new C('XCD', 'östkaribisk dollar', 'EC$', plurals: ['one' => 'östkaribisk dollar', 'other' => 'östkaribiska dollar']),
    ...
    'ZAR' => new C('ZAR', 'sydafrikansk rand', plurals: ['one' => 'sydafrikansk rand', 'other' => 'sydafrikanska rand']),
    'ZMK' => new C('ZMK', 'zambisk kwacha (1968–2012)', plurals: ['one' => 'zambisk kwacha (1968–2012)', 'other' => 'zambiska kwacha (1968–2012)']),
    'ZMW' => new C('ZMW', 'zambisk kwacha', plurals: ['one' => 'zambisk kwacha', 'other' => 'zambiska kwacha']),
