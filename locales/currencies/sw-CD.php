...
return [
    ...
    'CNY' => new C('CNY', 'Yuan Renminbi ya China', 'CN¥', '¥', ['one' => 'yuan ya Uchina', 'other' => 'yuan za Uchina']),
    'ETB' => new C('ETB', 'Bir ya Uhabeshi', plurals: ['one' => 'birr ya Uhabeshi', 'other' => 'birr za Uhabeshi']),
    'JPY' => new C('JPY', 'Sarafu ya Kijapani', 'JP¥', '¥', ['one' => 'yen ya Japani', 'other' => 'yen za Japani'], 0),
