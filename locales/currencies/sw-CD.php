...
return [
    ...
    'CNY' => new C('CNY', 'Yuan Renminbi ya China', 'CN¥', plurals: ['one' => 'yuan ya Uchina', 'other' => 'yuan za Uchina']),
    'ETB' => new C('ETB', 'Bir ya Uhabeshi', plurals: ['one' => 'birr ya Uhabeshi', 'other' => 'birr za Uhabeshi']),
    'JPY' => new C('JPY', 'Sarafu ya Kijapani', 'JP¥', plurals: ['one' => 'yen ya Japani', 'other' => 'yen za Japani'], minorUnits: 0),
    'MGA' => new C('MGA', 'Ariary ya Bukini', plurals: ['one' => 'ariari ya Madagaska', 'other' => 'ariari za Madagaska']),
