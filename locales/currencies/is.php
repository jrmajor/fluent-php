...
return [
    ...
    'GBP' => new C('GBP', 'sterlingspund', narrow: '£'),
    ...
    'GIP' => new C('GIP', 'Gíbraltarspund', narrow: '£'),
    ...
    'KGS' => new C('KGS', 'kirgiskt som', narrow: '⃀', plurals: ['one' => 'kirgiskt som', 'other' => 'kirgisk som']),
    ...
    'ROL' => new C('ROL', 'Rúmenskt lei (1952–2006)'),
    ...
    'SLE' => new C('SLE', 'síerraleónsk ljóna', plurals: ['one' => 'síerraleónsk ljóna', 'other' => 'síerraleónskar ljónur']),
    'SLL' => new C('SLL', 'síerraleónsk ljóna (1964—2022)', plurals: ['one' => 'síerraleónsk ljóna (1964—2022)', 'other' => 'síerraleónskar ljónur (1964—2022)']),
    ...
    'SVC' => new C('SVC', 'El Salvador Colon'),
    ...
    'TMM' => new C('TMM', 'Túrkmenskt manat (1993–2009)'),
