...
return [
    ...
    'ETB' => new C('ETB', 'Ethiopian Birr', plurals: ['other' => 'Ethiopian birr']),
    'JPY' => new C('JPY', 'Japanese Yen', 'JP¥', narrow: '¥', plurals: ['other' => 'Japanese yen'], minorUnits: 0),
    ...
    'MVR' => new C('MVR', 'Maldivian Rufiyaa', plurals: ['other' => 'Maldivian rufiyaa']),
    ...
    'VEF' => new C('VEF', 'Venezuelan Bolívar', narrow: 'Bs', plurals: ['one' => 'Venezuelan bolívar', 'other' => 'Venezuelan bolívars']),
    'VES' => new C('VES', plurals: ['other' => 'VES']),
