...
return [
    ...
    'BAM' => new C('BAM', 'Bosnia-Herzegovina Convertible Marka', narrow: 'KM', plurals: ['one' => 'Bosnia-Herzegovina convertible marka', 'other' => 'Bosnia-Herzegovina convertible marka']),
    ...
    'CNY' => new C('CNY', 'Chinese Yuan', narrow: '¥', plurals: ['one' => 'Chinese yuan', 'other' => 'Chinese yuan']),
    ...
    'GEL' => new C('GEL', 'Georgian Lari', narrow: '₾', plurals: ['one' => 'Georgian lari', 'other' => 'Georgian lari']),
    ...
    'KZT' => new C('KZT', 'Kazakhstani Tenge', narrow: '₸', plurals: ['one' => 'Kazakhstani tenge', 'other' => 'Kazakhstani tenge']),
    'LAK' => new C('LAK', 'Laotian Kip', narrow: '₭', plurals: ['one' => 'Laotian kip', 'other' => 'Laotian kip']),
    ...
    'VEF' => new C('VEF', 'Venezuelan Bolívar (2008–2018)', narrow: 'Bs', plurals: ['one' => 'Venezuelan bolívar', 'other' => 'Venezuelan bolívars']),
