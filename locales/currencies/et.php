...
return [
    ...
    'BYN' => new C('BYN', 'Valgevene rubla', plurals: ['other' => 'Valgevene rubla']),
    'BYR' => new C('BYR', 'Valgevene rubla (2000–2016)', plurals: ['other' => 'Valgevene rubla (2000–2016)']),
    ...
    'GEL' => new C('GEL', 'Gruusia lari', narrow: '₾', plurals: ['other' => 'Gruusia lari']),
    ...
    'HRK' => new C('HRK', 'Horvaatia kuna', narrow: 'kn', plurals: ['other' => 'Horvaatia kuna']),
    ...
    'LVR' => new C('LVR', 'Läti rubla', plurals: ['other' => 'Läti rubla']),
    ...
    'RUB' => new C('RUB', 'Venemaa rubla', narrow: '₽', plurals: ['other' => 'Venemaa rubla']),
    ...
    'TJR' => new C('TJR', 'Tadžikistani rubla', plurals: ['other' => 'Tadžikistani rubla']),
