...
return [
    ...
    'AFN' => new C('AFN', 'Afganistani afgaani', plurals: ['one' => 'Afganistani afgaani', 'other' => 'Afganistani afgaanit']),
    ...
    'AMD' => new C('AMD', 'Armeenia dramm', plurals: ['one' => 'Armeenia dramm', 'other' => 'Armeenia drammi']),
    'ANG' => new C('ANG', 'Hollandi Antillide kulden', plurals: ['one' => 'Hollandi Antillide kulden', 'other' => 'Hollandi Antillide kuldnat']),
    'AOA' => new C('AOA', 'Angola kvanza', plurals: ['one' => 'Angola kvanza', 'other' => 'Angola kvanzat']),
    ...
    'ARS' => new C('ARS', 'Argentina peeso', plurals: ['one' => 'Argentina peeso', 'other' => 'Argentina peesot']),
    'ATS' => new C('ATS', 'Austria šilling', plurals: ['one' => 'Austria šilling', 'other' => 'Austria šillingit']),
    'AUD' => new C('AUD', 'Austraalia dollar', 'AU$', plurals: ['one' => 'Austraalia dollar', 'other' => 'Austraalia dollarit']),
    ...
    'AZN' => new C('AZN', 'Aserbaidžaani manat', plurals: ['one' => 'Aserbaidžaani manat', 'other' => 'Aserbaidžaani manatit']),
    ...
    'BAM' => new C('BAM', 'Bosnia ja Hertsegoviina konverteeritav mark', plurals: ['one' => 'Bosnia ja Hertsegoviina konverteeritav mark', 'other' => 'Bosnia ja Hertsegoviina konverteeritavat marka']),
    ...
    'BBD' => new C('BBD', 'Barbadose dollar', plurals: ['one' => 'Barbadose dollar', 'other' => 'Barbadose dollarit']),
    'BDT' => new C('BDT', 'Bangladeshi taka', plurals: ['one' => 'Bangladeshi taka', 'other' => 'Bangladeshi takat']),
    ...
    'BMD' => new C('BMD', 'Bermuda dollar', plurals: ['one' => 'Bermuda dollar', 'other' => 'Bermuda dollarit']),
    'BND' => new C('BND', 'Brunei dollar', plurals: ['one' => 'Brunei dollar', 'other' => 'Brunei dollarit']),
    'BOB' => new C('BOB', 'Boliivia boliviaano', plurals: ['one' => 'Boliivia boliviaano', 'other' => 'Boliivia boliviaanot']),
    ...
    'BRL' => new C('BRL', 'Brasiilia reaal', 'R$', plurals: ['one' => 'Brasiilia reaal', 'other' => 'Brasiilia reaali']),
    'BRN' => new C('BRN'),
    ...
    'BSD' => new C('BSD', 'Bahama dollar', plurals: ['one' => 'Bahama dollar', 'other' => 'Bahama dollarit']),
    ...
    'BWP' => new C('BWP', 'Botswana pula', plurals: ['one' => 'Botswana pula', 'other' => 'Botswana pulat']),
    ...
    'BYN' => new C('BYN', 'Valgevene rubla', plurals: ['one' => 'Valgevene rubla', 'other' => 'Valgevene rubla']),
    'BYR' => new C('BYR', 'Valgevene rubla (2000–2016)', plurals: ['one' => 'Valgevene rubla (2000–2016)', 'other' => 'Valgevene rubla (2000–2016)']),
    'BZD' => new C('BZD', 'Belize’i dollar', plurals: ['one' => 'Belize’i dollar', 'other' => 'Belize’i dollarit']),
    'CAD' => new C('CAD', 'Kanada dollar', 'CA$', plurals: ['one' => 'Kanada dollar', 'other' => 'Kanada dollarit']),
    ...
    'CLP' => new C('CLP', 'Tšiili peeso', plurals: ['one' => 'Tšiili peeso', 'other' => 'Tšiili peesot'], minorUnits: 0),
    'CNH' => new C('CNH', 'Hiina jüaan (välismaine turg)', plurals: ['one' => 'Hiina jüaan (välismaine turg)', 'other' => 'Hiina jüaani (välismaine turg)']),
    'CNX' => new C('CNX'),
    'CNY' => new C('CNY', 'Hiina jüaan', 'CN¥', plurals: ['one' => 'Hiina jüaan', 'other' => 'Hiina jüaani']),
    'COP' => new C('COP', 'Colombia peeso', plurals: ['one' => 'Colombia peeso', 'other' => 'Colombia peesot']),
    'COU' => new C('COU'),
    'CRC' => new C('CRC', 'Costa Rica koloon', plurals: ['one' => 'Costa Rica koloon', 'other' => 'Costa Rica kolooni']),
    'CSD' => new C('CSD', 'Serbia dinaar (2002–2006)', plurals: ['one' => 'Serbia dinaar (2002–2006)', 'other' => 'Serbia dinaari (2002–2006)']),
    'CSK' => new C('CSK'),
    'CUC' => new C('CUC', 'Kuuba konverteeritav peeso', plurals: ['one' => 'Kuuba konverteeritav peeso', 'other' => 'Kuuba konverteeritavat peesot']),
    'CUP' => new C('CUP', 'Kuuba peeso', plurals: ['one' => 'Kuuba peeso', 'other' => 'Kuuba peesot']),
    ...
    'CZK' => new C('CZK', 'Tšehhi kroon', plurals: ['one' => 'Tšehhi kroon', 'other' => 'Tšehhi krooni']),
    ...
    'DKK' => new C('DKK', 'Taani kroon', plurals: ['one' => 'Taani kroon', 'other' => 'Taani krooni']),
    'DOP' => new C('DOP', 'Dominikaani peeso', plurals: ['one' => 'Dominikaani peeso', 'other' => 'Dominikaani peesot']),
    ...
    'EGP' => new C('EGP', 'Egiptuse nael', plurals: ['one' => 'Egiptuse nael', 'other' => 'Egiptuse naela']),
    'ERN' => new C('ERN', 'Eritrea nakfa', plurals: ['one' => 'Eritrea nakfa', 'other' => 'Eritrea nakfat']),
    'ESA' => new C('ESA'),
    'ESB' => new C('ESB'),
    'ESP' => new C('ESP', 'Hispaania peseeta', plurals: ['one' => 'Hispaania peseeta', 'other' => 'Hispaania peseetat']),
    'ETB' => new C('ETB', 'Etioopia birr', plurals: ['one' => 'Etioopia birr', 'other' => 'Etioopia birri']),
    'EUR' => new C('EUR', 'euro', '€', plurals: ['one' => 'euro', 'other' => 'eurot']),
    'FIM' => new C('FIM', 'Soome mark', plurals: ['one' => 'Soome mark', 'other' => 'Soome marka']),
    'FJD' => new C('FJD', 'Fidži dollar', plurals: ['one' => 'Fidži dollar', 'other' => 'Fidži dollarit']),
    'FKP' => new C('FKP', 'Falklandi saarte nael', plurals: ['one' => 'Falklandi saarte nael', 'other' => 'Falklandi saarte naela']),
    'FRF' => new C('FRF', 'Prantsuse frank', plurals: ['one' => 'Prantsuse frank', 'other' => 'Prantsuse franki']),
    'GBP' => new C('GBP', 'Suurbritannia naelsterling', '£', plurals: ['one' => 'Suurbritannia naelsterling', 'other' => 'Suurbritannia naelsterlingit']),
    'GEK' => new C('GEK'),
    'GEL' => new C('GEL', 'Gruusia lari', plurals: ['one' => 'Gruusia lari', 'other' => 'Gruusia lari']),
    'GHC' => new C('GHC', 'Ghana sedi (1979–2007)', plurals: ['one' => 'Ghana sedi (1979–2007)', 'other' => 'Ghana sedit (1979–2007)']),
    'GHS' => new C('GHS', 'Ghana sedi', plurals: ['one' => 'Ghana sedi', 'other' => 'Ghana sedit']),
    'GIP' => new C('GIP', 'Gibraltari nael', plurals: ['one' => 'Gibraltari nael', 'other' => 'Gibraltari naela']),
    'GMD' => new C('GMD', 'Gambia dalasi', plurals: ['one' => 'Gambia dalasi', 'other' => 'Gambia dalasit']),
    'GNF' => new C('GNF', 'Guinea frank', plurals: ['one' => 'Guinea frank', 'other' => 'Guinea franki'], minorUnits: 0),
    'GNS' => new C('GNS', 'Guinea syli'),
    'GQE' => new C('GQE'),
    'GRD' => new C('GRD', 'Kreeka drahm', plurals: ['one' => 'Kreeka drahm', 'other' => 'Kreeka drahmi']),
    'GTQ' => new C('GTQ', 'Guatemala ketsaal', plurals: ['one' => 'Guatemala ketsaal', 'other' => 'Guatemala ketsaali']),
    ...
    'GYD' => new C('GYD', 'Guyana dollar', plurals: ['one' => 'Guyana dollar', 'other' => 'Guyana dollarit']),
    'HKD' => new C('HKD', 'Hongkongi dollar', 'HK$', plurals: ['one' => 'Hongkongi dollar', 'other' => 'Hongkongi dollarit']),
    'HNL' => new C('HNL', 'Hondurase lempiira', plurals: ['one' => 'Hondurase lempiira', 'other' => 'Hondurase lempiirat']),
    'HRD' => new C('HRD', 'Horvaatia dinaar', plurals: ['one' => 'Horvaatia dinaar', 'other' => 'Horvaatia dinaari']),
    'HRK' => new C('HRK', 'Horvaatia kuna', plurals: ['one' => 'Horvaatia kuna', 'other' => 'Horvaatia kuna']),
    'HTG' => new C('HTG', 'Haiti gurd', plurals: ['one' => 'Haiti gurd', 'other' => 'Haiti gurdi']),
    'HUF' => new C('HUF', 'Ungari forint', plurals: ['one' => 'Ungari forint', 'other' => 'Ungari forintit']),
    'IDR' => new C('IDR', 'Indoneesia ruupia', plurals: ['one' => 'Indoneesia ruupia', 'other' => 'Indoneesia ruupiat']),
    ...
    'ILS' => new C('ILS', 'Iisraeli uus seekel', '₪', plurals: ['one' => 'Iisraeli uus seekel', 'other' => 'Iisraeli uut seeklit']),
    'INR' => new C('INR', 'India ruupia', '₹', plurals: ['one' => 'India ruupia', 'other' => 'India ruupiat']),
    ...
    'ISK' => new C('ISK', 'Islandi kroon', plurals: ['one' => 'Islandi kroon', 'other' => 'Islandi krooni'], minorUnits: 0),
    'ITL' => new C('ITL', 'Itaalia liir', plurals: ['one' => 'Itaalia liir', 'other' => 'Itaalia liiri']),
    'JMD' => new C('JMD', 'Jamaica dollar', plurals: ['one' => 'Jamaica dollar', 'other' => 'Jamaica dollarit']),
    'JOD' => new C('JOD', 'Jordaania dinaar', plurals: ['one' => 'Jordaania dinaar', 'other' => 'Jordaania dinaari'], minorUnits: 3),
    'JPY' => new C('JPY', 'Jaapani jeen', '¥', plurals: ['one' => 'Jaapani jeen', 'other' => 'Jaapani jeeni'], minorUnits: 0),
    ...
    'KHR' => new C('KHR', 'Kambodža riaal', plurals: ['one' => 'Kambodža riaal', 'other' => 'Kambodža riaali']),
    'KMF' => new C('KMF', 'Komoori frank', plurals: ['one' => 'Komoori frank', 'other' => 'Komoori franki'], minorUnits: 0),
    'KPW' => new C('KPW', 'Põhja-Korea vonn', plurals: ['one' => 'Põhja-Korea vonn', 'other' => 'Põhja-Korea vonni']),
    'KRH' => new C('KRH'),
    'KRO' => new C('KRO', 'Lõuna-Korea vonn (1945–1953)', plurals: ['one' => 'Lõuna-Korea vonn (1945–1953)', 'other' => 'Lõuna-Korea vonni (1945–1953)']),
    'KRW' => new C('KRW', 'Lõuna-Korea vonn', '₩', plurals: ['one' => 'Lõuna-Korea vonn', 'other' => 'Lõuna-Korea vonni'], minorUnits: 0),
    'KWD' => new C('KWD', 'Kuveidi dinaar', plurals: ['one' => 'Kuveidi dinaar', 'other' => 'Kuveidi dinaari'], minorUnits: 3),
    'KYD' => new C('KYD', 'Kaimanisaarte dollar', plurals: ['one' => 'Kaimanisaarte dollar', 'other' => 'Kaimanisaarte dollarit']),
    'KZT' => new C('KZT', 'Kasahstani tenge', plurals: ['one' => 'Kasahstani tenge', 'other' => 'Kasahstani tenget']),
    'LAK' => new C('LAK', 'Laose kiip', plurals: ['one' => 'Laose kiip', 'other' => 'Laose kiipi']),
    'LBP' => new C('LBP', 'Liibanoni nael', plurals: ['one' => 'Liibanoni nael', 'other' => 'Liibanoni naela']),
    'LKR' => new C('LKR', 'Sri Lanka ruupia', plurals: ['one' => 'Sri Lanka ruupia', 'other' => 'Sri Lanka ruupiat']),
    'LRD' => new C('LRD', 'Libeeria dollar', plurals: ['one' => 'Libeeria dollar', 'other' => 'Libeeria dollarit']),
    'LSL' => new C('LSL', 'Lesotho loti', plurals: ['one' => 'Lesotho loti', 'other' => 'Lesotho lotit']),
    'LTL' => new C('LTL', 'Leedu litt', plurals: ['one' => 'Leedu litt', 'other' => 'Leedu litti']),
    'LTT' => new C('LTT'),
    ...
    'LUL' => new C('LUL'),
    'LVL' => new C('LVL', 'Läti latt', plurals: ['one' => 'Läti latt', 'other' => 'Läti latti']),
    'LVR' => new C('LVR', 'Läti rubla', plurals: ['one' => 'Läti rubla', 'other' => 'Läti rubla']),
    ...
    'MGA' => new C('MGA', 'Madagaskari ariari', plurals: ['one' => 'Madagaskari ariari', 'other' => 'Madagaskari ariarit']),
    'MGF' => new C('MGF', 'Madagaskar frank', plurals: ['one' => 'Madagaskar frank', 'other' => 'Madagaskar franki']),
    ...
    'MMK' => new C('MMK', 'Myanmari kjatt', plurals: ['one' => 'Myanmari kjatt', 'other' => 'Myanmari kjatti']),
    'MNT' => new C('MNT', 'Mongoolia tugrik', plurals: ['one' => 'Mongoolia tugrik', 'other' => 'Mongoolia tugrikut']),
    ...
    'MUR' => new C('MUR', 'Mauritiuse ruupia', plurals: ['one' => 'Mauritiuse ruupia', 'other' => 'Mauritiuse ruupiat']),
    ...
    'MXN' => new C('MXN', 'Mehhiko peeso', 'MX$', plurals: ['one' => 'Mehhiko peeso', 'other' => 'Mehhiko peesot']),
    'MXP' => new C('MXP', 'Mehhiko peeso (1861–1992)', plurals: ['one' => 'Mehhiko peeso (1861–1992)', 'other' => 'Mehhiko peesot (1861–1992)']),
    'MXV' => new C('MXV'),
    'MYR' => new C('MYR', 'Malaisia ringgit', plurals: ['one' => 'Malaisia ringgit', 'other' => 'Malaisia ringgitit']),
    ...
    'NAD' => new C('NAD', 'Namiibia dollar', plurals: ['one' => 'Namiibia dollar', 'other' => 'Namiibia dollarit']),
    'NGN' => new C('NGN', 'Nigeeria naira', plurals: ['one' => 'Nigeeria naira', 'other' => 'Nigeeria nairat']),
    'NIC' => new C('NIC', 'Nicaragua kordoba (1988–1991)', plurals: ['one' => 'Nicaragua kordoba (1988–1991)', 'other' => 'Nicaragua kordobat (1988–1991)']),
    'NIO' => new C('NIO', 'Nicaragua kordoba', plurals: ['one' => 'Nicaragua kordoba', 'other' => 'Nicaragua kordobat']),
    'NLG' => new C('NLG', 'Hollandi kulden', plurals: ['one' => 'Hollandi kulden', 'other' => 'Hollandi kuldnat']),
    'NOK' => new C('NOK', 'Norra kroon', plurals: ['one' => 'Norra kroon', 'other' => 'Norra krooni']),
    'NPR' => new C('NPR', 'Nepali ruupia', plurals: ['one' => 'Nepali ruupia', 'other' => 'Nepali ruupiat']),
    'NZD' => new C('NZD', 'Uus-Meremaa dollar', 'NZ$', plurals: ['one' => 'Uus-Meremaa dollar', 'other' => 'Uus-Meremaa dollarit']),
    ...
    'PHP' => new C('PHP', 'Filipiini peeso', plurals: ['one' => 'Filipiini peeso', 'other' => 'Filipiini peesot']),
    'PKR' => new C('PKR', 'Pakistani ruupia', plurals: ['one' => 'Pakistani ruupia', 'other' => 'Pakistani ruupiat']),
    'PLN' => new C('PLN', 'Poola zlott', plurals: ['one' => 'Poola zlott', 'other' => 'Poola zlotti']),
    ...
    'PYG' => new C('PYG', 'Paraguay guaranii', plurals: ['one' => 'Paraguay guaranii', 'other' => 'Paraguay guaraniid'], minorUnits: 0),
    ...
    'RON' => new C('RON', 'Rumeenia leu', plurals: ['one' => 'Rumeenia leu', 'other' => 'Rumeenia leud']),
    'RSD' => new C('RSD', 'Serbia dinaar', plurals: ['one' => 'Serbia dinaar', 'other' => 'Serbia dinaari']),
    'RUB' => new C('RUB', 'Venemaa rubla', plurals: ['one' => 'Venemaa rubla', 'other' => 'Venemaa rubla']),
    'RUR' => new C('RUR', 'Venemaa rubla (1991–1998)'),
    'RWF' => new C('RWF', 'Rwanda frank', plurals: ['one' => 'Rwanda frank', 'other' => 'Rwanda franki'], minorUnits: 0),
    'SAR' => new C('SAR', 'Saudi Araabia riaal', plurals: ['one' => 'Saudi Araabia riaal', 'other' => 'Saudi Araabia riaali']),
    'SBD' => new C('SBD', 'Saalomoni Saarte dollar', plurals: ['one' => 'Saalomoni Saarte dollar', 'other' => 'Saalomoni Saarte dollarit']),
    ...
    'SEK' => new C('SEK', 'Rootsi kroon', plurals: ['one' => 'Rootsi kroon', 'other' => 'Rootsi krooni']),
    'SGD' => new C('SGD', 'Singapuri dollar', plurals: ['one' => 'Singapuri dollar', 'other' => 'Singapuri dollarit']),
    'SHP' => new C('SHP', 'Saint Helena nael', plurals: ['one' => 'Saint Helena nael', 'other' => 'Saint Helena naela']),
    ...
    'SRD' => new C('SRD', 'Suriname dollar', plurals: ['one' => 'Suriname dollar', 'other' => 'Suriname dollarit']),
    'SRG' => new C('SRG', 'Suriname kulden', plurals: ['one' => 'Suriname kulden', 'other' => 'Suriname kuldnat']),
    'SSP' => new C('SSP', 'Lõuna-Sudaani nael', plurals: ['one' => 'Lõuna-Sudaani nael', 'other' => 'Lõuna-Sudaani naela']),
    ...
    'STN' => new C('STN', 'São Tomé ja Príncipe dobra', plurals: ['one' => 'São Tomé ja Príncipe dobra', 'other' => 'São Tomé ja Príncipe dobrat']),
    'SUR' => new C('SUR', 'NSVL-i rubla'),
    'SVC' => new C('SVC', 'El Salvadori koloon', plurals: ['one' => 'El Salvadori koloon', 'other' => 'El Salvadori kolooni']),
    'SYP' => new C('SYP', 'Süüria nael', plurals: ['one' => 'Süüria nael', 'other' => 'Süüria naela']),
    'SZL' => new C('SZL', 'Svaasimaa lilangeni', plurals: ['one' => 'Svaasimaa lilangeni', 'other' => 'Svaasimaa lilangenit']),
    'THB' => new C('THB', 'Tai baat', '฿', plurals: ['one' => 'Tai baat', 'other' => 'Tai baati']),
    'TJR' => new C('TJR', 'Tadžikistani rubla', plurals: ['one' => 'Tadžikistani rubla', 'other' => 'Tadžikistani rubla']),
    ...
    'TOP' => new C('TOP', 'Tonga pa’anga', plurals: ['one' => 'Tonga pa’anga', 'other' => 'Tonga pa’angat']),
    ...
    'TRY' => new C('TRY', 'Türgi liir', plurals: ['one' => 'Türgi liir', 'other' => 'Türgi liiri']),
    'TTD' => new C('TTD', 'Trinidadi ja Tobago dollar', plurals: ['one' => 'Trinidadi ja Tobago dollar', 'other' => 'Trinidadi ja Tobago dollarit']),
    'TWD' => new C('TWD', 'uus Taiwani dollar', 'NT$', plurals: ['one' => 'uus Taiwani dollar', 'other' => 'uut Taiwani dollarit']),
    'TZS' => new C('TZS', 'Tansaania šilling', plurals: ['one' => 'Tansaania šilling', 'other' => 'Tansaania šillingit']),
    'UAH' => new C('UAH', 'Ukraina grivna', plurals: ['one' => 'Ukraina grivna', 'other' => 'Ukraina grivnat']),
    ...
    'USD' => new C('USD', 'USA dollar', '$', plurals: ['one' => 'USA dollar', 'other' => 'USA dollarit']),
    ...
    'UYU' => new C('UYU', 'Uruguay peeso', plurals: ['one' => 'Uruguay peeso', 'other' => 'Uruguay peesot']),
    ...
    'VEF' => new C('VEF', 'Venezuela boliivar (2008–2018)', plurals: ['one' => 'Venezuela boliivar (2008–2018)', 'other' => 'Venezuela boliivarit (2008–2018)']),
    'VES' => new C('VES', 'Venezuela boliivar', plurals: ['one' => 'Venezuela boliivar', 'other' => 'Venezuela boliivarit']),
    'VND' => new C('VND', 'Vietnami dong', '₫', plurals: ['one' => 'Vietnami dong', 'other' => 'Vietnami dongi'], minorUnits: 0),
    ...
    'XCD' => new C('XCD', 'Ida-Kariibi dollar', 'EC$', plurals: ['one' => 'Ida-Kariibi dollar', 'other' => 'Ida-Kariibi dollarit']),
    ...
    'YUR' => new C('YUR'),
    'ZAL' => new C('ZAL'),
    'ZAR' => new C('ZAR', 'Lõuna-Aafrika rand', plurals: ['one' => 'Lõuna-Aafrika rand', 'other' => 'Lõuna-Aafrika randi']),
    'ZMK' => new C('ZMK', 'Sambia kvatša (1968–2012)', plurals: ['one' => 'Sambia kvatša (1968–2012)', 'other' => 'Sambia kvatšat (1968–2012)']),
    'ZMW' => new C('ZMW', 'Sambia kvatša', plurals: ['one' => 'Sambia kvatša', 'other' => 'Sambia kvatšat']),
    'ZRN' => new C('ZRN'),
