...
return [
    ...
    'BYN' => new C('BYN', 'Valgevene rubla', narrow: 'р.', plurals: ['one' => 'Valgevene rubla', 'other' => 'Valgevene rubla']),
    ...
    'GEL' => new C('GEL', 'Gruusia lari', narrow: '₾', plurals: ['one' => 'Gruusia lari', 'other' => 'Gruusia lari']),
    ...
    'HRK' => new C('HRK', 'Horvaatia kuna', narrow: 'kn', plurals: ['one' => 'Horvaatia kuna', 'other' => 'Horvaatia kuna']),
    ...
    'RUB' => new C('RUB', 'Venemaa rubla', narrow: '₽', plurals: ['one' => 'Venemaa rubla', 'other' => 'Venemaa rubla']),
    'RUR' => new C('RUR', 'Venemaa rubla (1991–1998)', narrow: 'р.'),
