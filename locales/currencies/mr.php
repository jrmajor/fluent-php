...
return [
    ...
    'AFN' => new C('AFN', 'अफगाण अफगाणी', narrow: '؋', plurals: ['one' => 'अफगाण अफगाणी', 'other' => 'अफगाण अफगाणी']),
    'ALL' => new C('ALL', 'अल्बानियन लेक', plurals: ['one' => 'अल्बानियन लेक', 'other' => 'अल्बानियन लेके']),
    'AMD' => new C('AMD', 'आर्मेनियन द्रॅम', narrow: '֏', plurals: ['one' => 'आर्मेनियन द्रॅम', 'other' => 'आर्मेनियन द्रॅम']),
    ...
    'AZN' => new C('AZN', 'अझरबैझानी मानाट', narrow: '₼', plurals: ['one' => 'अझरबैझानी मानाट', 'other' => 'अझरबैझानी मानाट']),
    ...
    'BDT' => new C('BDT', 'बांगलादेशी टका', narrow: '৳', plurals: ['one' => 'बांगलादेशी टका', 'other' => 'बांगलादेशी टका']),
    ...
    'BYN' => new C('BYN', 'बेलारुशियन रुबल', narrow: 'р.', plurals: ['one' => 'बेलारुशियन रुबल', 'other' => 'बेलारुशियन रुबल्स']),
    ...
    'DKK' => new C('DKK', 'डॅनिश क्रोन', narrow: 'kr', plurals: ['one' => 'डॅनिश क्रोन', 'other' => 'डॅनिश क्रोन']),
    ...
    'FJD' => new C('FJD', 'फिजियन डॉलर', narrow: '$', plurals: ['one' => 'फिजियन डॉलर्स', 'other' => 'फिजियन डॉलर्स']),
    ...
    'IDR' => new C('IDR', 'इंडोनेशियन रुपिया', narrow: 'Rp', plurals: ['one' => 'इंडोनेशियन रुपिया', 'other' => 'इंडोनेशियन रुपिया']),
    'ILS' => new C('ILS', 'ईस्त्रायली न्यू शेकेल', '₪', narrow: '₪', plurals: ['one' => 'ईस्त्रायली न्यू शेकेल', 'other' => 'ईस्त्रायली न्यू शेकेल']),
    ...
    'JPY' => new C('JPY', 'जपानी येन', 'JP¥', narrow: '¥', plurals: ['one' => 'जपानी येन', 'other' => 'जपानी येन'], minorUnits: 0),
    ...
    'KHR' => new C('KHR', 'कंबोडियन रियेल', narrow: '៛', plurals: ['one' => 'कंबोडियन रियेल', 'other' => 'कंबोडियन रियेल']),
    'KMF' => new C('KMF', 'कोमोरियन फ्रँक', narrow: 'CF', plurals: ['one' => 'कोमोरियन फ्रँक', 'other' => 'कोमोरियन फ्रँक्स'], minorUnits: 0),
    'KPW' => new C('KPW', 'उत्तर कोरियन वॉन', narrow: '₩', plurals: ['one' => 'उत्तर कोरियन वॉन', 'other' => 'उत्तर कोरियन वॉन']),
    'KRW' => new C('KRW', 'दक्षिण कोरियन वॉन', '₩', narrow: '₩', plurals: ['one' => 'दक्षिण कोरियन वॉन', 'other' => 'दक्षिण कोरियन वॉन'], minorUnits: 0),
    ...
    'KZT' => new C('KZT', 'कझाकिस्तानी तेंगे', narrow: '₸', plurals: ['one' => 'कझाकिस्तानी तेंगे', 'other' => 'कझाकिस्तानी तेंगे']),
    ...
    'MMK' => new C('MMK', 'म्यानमार क्याट', narrow: 'K', plurals: ['one' => 'म्यानमार क्याट', 'other' => 'म्यानमार क्याट']),
    ...
    'MYR' => new C('MYR', 'मलेशियन रिंगिट', narrow: 'RM', plurals: ['one' => 'मलेशियन रिंगिट', 'other' => 'मलेशियन रिंगिट']),
    ...
    'NIO' => new C('NIO', 'निकाराग्वेचा कोर्डोबा', narrow: 'C$', plurals: ['one' => 'निकाराग्वेचा कोर्डोबा', 'other' => 'निकाराग्वन कोर्डोबाज']),
    ...
    'THB' => new C('THB', 'थाई बाहत', '฿', narrow: '฿', plurals: ['one' => 'थाई बाहत', 'other' => 'थाई बाहत']),
    ...
    'TOP' => new C('TOP', 'टोंगन पाआंगा', narrow: 'T$', plurals: ['one' => 'टोंगन पाआंगा', 'other' => 'टोंगन पाआंगा']),
    'TRY' => new C('TRY', 'तुर्की लिरा', narrow: '₺', plurals: ['one' => 'तुर्की लिरा', 'other' => 'तुर्की लिरा']),
    ...
    'VND' => new C('VND', 'व्हिएतनामी डोंग', '₫', narrow: '₫', plurals: ['one' => 'व्हिएतनामी डोंग', 'other' => 'व्हिएतनामी डोंग'], minorUnits: 0),
    ...
    'ZAR' => new C('ZAR', 'दक्षिण आफ्रिकी रँड', narrow: 'R', plurals: ['one' => 'दक्षिण आफ्रिकी रँड', 'other' => 'दक्षिण आफ्रिकी रँड']),
