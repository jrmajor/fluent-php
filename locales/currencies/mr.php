...
return [
    'AED' => new C('AED', 'संयुक्त अरब अमीरात दिरहॅम'),
    'AFN' => new C('AFN', 'अफगाण अफगाणी', narrow: '؋'),
    'ALL' => new C('ALL', 'अल्बानियन लेक', plurals: ['one' => 'अल्बानियन लेक', 'other' => 'अल्बानियन लेके']),
    'AMD' => new C('AMD', 'आर्मेनियन द्रॅम', narrow: '֏'),
    ...
    'AUD' => new C('AUD', 'ऑस्ट्रेलियन डॉलर', 'A$', '$', ['one' => 'ऑस्ट्रेलियन डॉलर', 'other' => 'ऑस्ट्रेलियन डॉलर्स']),
    'AWG' => new C('AWG', 'अरुबा फ्लोरिन'),
    'AZN' => new C('AZN', 'अझरबैझानी मानाट', narrow: '₼'),
    ...
    'BDT' => new C('BDT', 'बांगलादेशी टका', narrow: '৳'),
    'BGN' => new C('BGN', 'बल्गेरियन लेव', plurals: ['one' => 'बल्गेरियन लेव', 'other' => 'बल्गेरियन लेवा']),
    'BHD' => new C('BHD', 'बाहरिनी दिनार', minorUnits: 3),
    ...
    'BRL' => new C('BRL', 'ब्राझिलियन रियाल', 'R$', 'R$', ['one' => 'ब्राझिलियन रियाल', 'other' => 'ब्राझिलियन रियाल्स']),
    'BSD' => new C('BSD', 'बहामी डॉलर', narrow: '$', plurals: ['one' => 'बहामी डॉलर', 'other' => 'बहामी डॉलर्स']),
    'BTN' => new C('BTN', 'भूतानी एंगल्ट्रम'),
    ...
    'CAD' => new C('CAD', 'कॅनडियन डॉलर', 'CA$', '$', ['one' => 'कॅनडियन डॉलर', 'other' => 'कॅनडियन डॉलर्स']),
    ...
    'GBP' => new C('GBP', 'ब्रिटिश पाऊंड', '£', '£', ['one' => 'ब्रिटिश पाऊंड', 'other' => 'ब्रिटिश पाऊंड्स']),
    ...
    'HKD' => new C('HKD', 'हाँगकाँग डॉलर', 'HK$', '$', ['one' => 'हाँगकाँग डॉलर', 'other' => 'हाँगकाँग डॉलर्स']),
    ...
    'ILS' => new C('ILS', 'ईस्त्रायली न्यू शेकेल', '₪', '₪'),
    'INR' => new C('INR', 'भारतीय रुपया', '₹', '₹', ['one' => 'भारतीय रुपया', 'other' => 'भारतीय रुपये']),
    'IQD' => new C('IQD', 'इराकी दिनार', minorUnits: 3),
    'IRR' => new C('IRR', 'इराणी रियाल'),
    ...
    'KGS' => new C('KGS', 'किरगिस्तानी सॉम', narrow: '⃀'),
    'KHR' => new C('KHR', 'कंबोडियन रियेल', narrow: '៛'),
    ...
    'KZT' => new C('KZT', 'कझाकिस्तानी तेंगे', narrow: '₸'),
    ...
    'MMK' => new C('MMK', 'म्यानमार क्याट', narrow: 'K'),
    ...
    'MVR' => new C('MVR', 'मालदीवियन रुफिया'),
    'MWK' => new C('MWK', 'मालावियन क्वाचा', plurals: ['one' => 'मालावियन क्वाचा', 'other' => 'मालावियन क्वाचास']),
    'MXN' => new C('MXN', 'मेक्सिको पेसो', 'MX$', '$', ['one' => 'मेक्सिको पेसो', 'other' => 'मेक्सिको पेसोज']),
    'MYR' => new C('MYR', 'मलेशियन रिंगिट', narrow: 'RM'),
    ...
    'NZD' => new C('NZD', 'न्यूझीलँड डॉलर', 'NZ$', '$', ['one' => 'न्यूझीलँड डॉलर', 'other' => 'न्यूझीलँड डॉलर्स']),
    ...
    'SLE' => new C('SLE', 'सिएरा लिऑनचा लिऑन', plurals: ['one' => 'सिएरा लिऑनचा लिऑन', 'other' => 'सिएरा लिऑनचे लिऑन्स']),
    'SLL' => new C('SLL', 'सिएरा लिऑनचा लिऑन (1964—2022)', plurals: ['one' => 'सिएरा लिऑनचा लिऑन (1964—2022)', 'other' => 'सिएरा लिऑनचे लिऑन्स (1964—2022)']),
    ...
    'THB' => new C('THB', 'थाई बाहत', '฿', '฿'),
    'TJS' => new C('TJS', 'ताजकीस्तानी सोमोनी', plurals: ['one' => 'ताजकीस्तानी सोमोनी', 'other' => 'ताजकीस्तानी सोमोनीज']),
    'TMT' => new C('TMT', 'तुर्कमेनिस्तानी मानाट'),
    'TND' => new C('TND', 'ट्यूनिशियन दिनार', minorUnits: 3),
    'TOP' => new C('TOP', 'टोंगन पाआंगा', narrow: 'T$'),
    'TRY' => new C('TRY', 'तुर्की लिरा', narrow: '₺'),
    'TTD' => new C('TTD', 'त्रिनिदाद आणि टोबॅगो डॉलर', narrow: '$', plurals: ['one' => 'त्रिनिदाद आणि टोबॅगो डॉलर', 'other' => 'त्रिनिदाद आणि टोबॅगो डॉलर्स']),
    'TWD' => new C('TWD', 'न्यू तैवान डॉलर', 'NT$', 'NT$', ['one' => 'न्यू तैवान डॉलर', 'other' => 'न्यू तैवान डॉलर्स']),
    ...
    'USD' => new C('USD', 'यूएस डॉलर', '$', '$', ['one' => 'यूएस डॉलर', 'other' => 'यूएस डॉलर्स']),
    'UYU' => new C('UYU', 'उरुग्वेचा पेसो', narrow: '$', plurals: ['one' => 'उरुग्वेचा पेसो', 'other' => 'उरुग्वेचे पेसोज']),
    'UZS' => new C('UZS', 'उझबेकिस्तानी सोम'),
    ...
    'VND' => new C('VND', 'व्हिएतनामी डोंग', '₫', '₫', minorUnits: 0),
    'VUV' => new C('VUV', 'वानुआतु वाटु', minorUnits: 0),
    'WST' => new C('WST', 'सामोअन टाला'),
    'XAF' => new C('XAF', 'मध्य आफ्रिकन [CFA] फ्रँक', 'FCFA', minorUnits: 0),
    'XCD' => new C('XCD', 'पूर्व कॅरीबियन डॉलर', 'EC$', '$', ['one' => 'पूर्व कॅरीबियन डॉलर', 'other' => 'पूर्व कॅरीबियन डॉलर्स']),
    ...
    'ZAR' => new C('ZAR', 'दक्षिण आफ्रिकी रँड', narrow: 'R'),
