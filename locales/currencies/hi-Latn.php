...
return [
    ...
    'AUD' => new C('AUD', 'Australian Dollar', 'A$', narrow: '$', plurals: ['one' => 'Australian dollar', 'other' => 'Australian dollars']),
    ...
    'BRL' => new C('BRL', 'Brazilian Real', 'R$', narrow: 'R$', plurals: ['one' => 'Brazilian real', 'other' => 'Brazilian reals']),
    ...
    'CAD' => new C('CAD', 'Canadian Dollar', 'CA$', narrow: '$', plurals: ['one' => 'Canadian dollar', 'other' => 'Canadian dollars']),
    ...
    'CRC' => new C('CRC', 'Costa Rican colon', narrow: '₡', plurals: ['one' => 'Costa Rican colon', 'other' => 'Costa Rican colons']),
    ...
    'HKD' => new C('HKD', 'Hong Kong Dollar', 'HK$', narrow: '$', plurals: ['one' => 'Hong Kong dollar', 'other' => 'Hong Kong dollars']),
    ...
    'ILS' => new C('ILS', 'Israeli New Shekel', '₪', narrow: '₪', plurals: ['one' => 'Israeli new shekel', 'other' => 'Israeli new shekels']),
    ...
    'ISK' => new C('ISK', 'Icelandic krona', narrow: 'kr', plurals: ['one' => 'Icelandic krona', 'other' => 'Icelandic kronur'], minorUnits: 0),
    ...
    'KPW' => new C('KPW', 'North Korean Won', narrow: '₩', plurals: ['one' => 'North Korean won', 'other' => 'North Korean won']),
    ...
    'KRW' => new C('KRW', 'South Korean Won', '₩', narrow: '₩', plurals: ['one' => 'South Korean won', 'other' => 'South Korean won'], minorUnits: 0),
    ...
    'MXN' => new C('MXN', 'Mexican Peso', 'MX$', narrow: '$', plurals: ['one' => 'Mexican peso', 'other' => 'Mexican pesos']),
    ...
    'NIO' => new C('NIO', 'Nicaraguan cordoba', narrow: 'C$', plurals: ['one' => 'Nicaraguan cordoba', 'other' => 'Nicaraguan cordobas']),
    ...
    'NZD' => new C('NZD', 'New Zealand Dollar', 'NZ$', narrow: '$', plurals: ['one' => 'New Zealand dollar', 'other' => 'New Zealand dollars']),
    ...
    'STN' => new C('STN', 'Sao Tome & Principe Dobra', narrow: 'Db', plurals: ['one' => 'Sao Tome & Principe dobra', 'other' => 'Sao Tome & Principe dobras']),
    ...
    'TWD' => new C('TWD', 'New Taiwan Dollar', 'NT$', narrow: '$', plurals: ['one' => 'New Taiwan dollar', 'other' => 'New Taiwan dollars']),
    ...
    'VES' => new C('VES', 'Venezuelan bolivar', plurals: ['one' => 'Venezuelan bolivar', 'other' => 'Venezuelan bolivars']),
    ...
    'XCD' => new C('XCD', 'East Caribbean Dollar', 'EC$', narrow: '$', plurals: ['one' => 'East Caribbean dollar', 'other' => 'East Caribbean dollars']),
    ...
    'XXX' => new C('XXX', 'Unknown Currency', '¤', plurals: ['one' => 'currency ki unknown unit', 'other' => '(unknown currency)']),
    ...
    'ZAR' => new C('ZAR', 'South African Rand', narrow: 'R', plurals: ['one' => 'South African rand', 'other' => 'South African rand']),
