...
return [
    ...
    'AWG' => new C('AWG', 'Aruban Florin', plurals: ['other' => 'Aruban florin']),
    ...
    'GQE' => new C('GQE', 'Equatorial Guinean Ekwele', plurals: ['other' => 'Equatorial Guinean ekwele']),
    ...
    'KPW' => new C('KPW', 'North Korean Won', narrow: '₩', plurals: ['other' => 'North Korean won']),
    'KRH' => new C('KRH', 'South Korean Hwan (1953–1962)', plurals: ['other' => 'South Korean hwan (1953–1962)']),
    'KRO' => new C('KRO', 'South Korean Won (1945–1953)', plurals: ['other' => 'South Korean won (1945–1953)']),
    ...
    'MDC' => new C('MDC', 'Moldovan Cupon', plurals: ['other' => 'Moldovan cupon']),
    ...
    'MTL' => new C('MTL', 'Maltese Lira', plurals: ['other' => 'Maltese lira']),
    ...
    'TMM' => new C('TMM', 'Turkmenistani Manat (1993–2009)', plurals: ['other' => 'Turkmenistani manat (1993–2009)']),
    ...
    'UZS' => new C('UZS', 'Uzbekistani Som', plurals: ['other' => 'Uzbekistani som']),
    ...
    'ZAR' => new C('ZAR', 'South African Rand', narrow: 'R', plurals: ['other' => 'South African rand']),
