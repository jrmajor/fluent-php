...
return [
    ...
    'AED' => new C('AED', 'dirham degli Emirati Arabi Uniti', plurals: ['other' => 'dirham degli EAU']),
    'AFA' => new C('AFA', 'afgani (1927–2002)'),
    'AFN' => new C('AFN', 'afghani', narrow: '؋', plurals: ['other' => 'afghani']),
    ...
    'BWP' => new C('BWP', 'pula del Botswana', narrow: 'P', plurals: ['other' => 'pula del Botswana']),
    ...
    'ITL' => new C('ITL', 'lira italiana', plurals: ['other' => 'lire italiane']),
    ...
    'MMK' => new C('MMK', 'kyat di Myanmar', narrow: 'K', plurals: ['other' => 'kyat di Myanmar']),
    ...
    'MRO' => new C('MRO', 'ouguiya della Mauritania (1973–2017)', plurals: ['other' => 'ouguiya della Mauritania (1973–2017)']),
    'MRU' => new C('MRU', 'ouguiya della Mauritania', plurals: ['other' => 'ouguiya della Mauritania']),
    ...
    'MVR' => new C('MVR', 'rufiyaa delle Maldive', plurals: ['other' => 'rufiyaa delle Maldive']),
    ...
    'NIC' => new C('NIC', 'cordoba nicaraguense', plurals: ['other' => 'cordoba nicaraguense']),
    ...
    'STD' => new C('STD', 'dobra di Sao Tomé e Principe (1977–2017)', plurals: ['other' => 'dobra di Sao Tomé e Principe (1977–2017)']),
    'STN' => new C('STN', 'dobra di Sao Tomé e Príncipe', narrow: 'Db', plurals: ['other' => 'dobra di Sao Tomé e Príncipe']),
    ...
    'SZL' => new C('SZL', 'lilangeni dello Swaziland', plurals: ['other' => 'lilangeni dello Swaziland']),
    ...
    'VUV' => new C('VUV', 'vatu di Vanuatu', plurals: ['other' => 'vatu di Vanuatu'], minorUnits: 0),
