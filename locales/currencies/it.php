...
return [
    ...
    'BWP' => new C('BWP', 'pula del Botswana', narrow: 'P'),
    ...
    'CNY' => new C('CNY', 'yuan cinese', 'CN¥', '¥', ['one' => 'yuan cinese', 'other' => 'yuan cinesi']),
    ...
    'KGS' => new C('KGS', 'som kirghiso', narrow: '⃀', plurals: ['one' => 'som kirghiso', 'other' => 'som kirghisi']),
    ...
    'MMK' => new C('MMK', 'kyat di Myanmar', narrow: 'K'),
    ...
    'MRO' => new C('MRO', 'ouguiya della Mauritania (1973–2017)'),
    'MRU' => new C('MRU', 'ouguiya della Mauritania'),
    ...
    'MVR' => new C('MVR', 'rufiyaa delle Maldive'),
    ...
    'NIC' => new C('NIC', 'cordoba nicaraguense'),
    ...
    'SLE' => new C('SLE', 'leone della Sierra Leone', plurals: ['one' => 'leone della Sierra Leone', 'other' => 'leoni della Sierra Leone']),
    'SLL' => new C('SLL', 'leone della Sierra Leone (1964–2022)', plurals: ['one' => 'leone della Sierra Leone (1964–2022)', 'other' => 'leoni della Sierra Leone (1964–2022)']),
    ...
    'STD' => new C('STD', 'dobra di Sao Tomé e Principe (1977–2017)'),
    'STN' => new C('STN', 'dobra di Sao Tomé e Príncipe', narrow: 'Db'),
    ...
    'SZL' => new C('SZL', 'lilangeni', plurals: ['one' => 'lilangeni', 'other' => 'emalangeni']),
    ...
    'VUV' => new C('VUV', 'vatu di Vanuatu', minorUnits: 0),
