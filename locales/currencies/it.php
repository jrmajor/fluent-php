...
return [
    ...
    'AED' => new C('AED', 'dirham degli Emirati Arabi Uniti', plurals: 'dirham degli EAU'),
    'AFA' => new C('AFA', 'afgani (1927–2002)'),
    'AFN' => new C('AFN', 'afghani', narrow: '؋', plurals: 'afghani'),
    ...
    'AUD' => new C('AUD', 'dollaro australiano', 'A$', '$', ['one' => 'dollaro australiano', 'other' => 'dollari australiani']),
    ...
    'BWP' => new C('BWP', 'pula del Botswana', narrow: 'P', plurals: 'pula del Botswana'),
    ...
    'CAD' => new C('CAD', 'dollaro canadese', 'CA$', '$', ['one' => 'dollaro canadese', 'other' => 'dollari canadesi']),
    ...
    'CNY' => new C('CNY', 'renminbi cinese', 'CN¥', '¥', ['one' => 'renmimbi cinese', 'other' => 'renmimbi cinesi']),
    ...
    'GBP' => new C('GBP', 'sterlina britannica', '£', '£', ['one' => 'sterlina britannica', 'other' => 'sterline britanniche']),
    ...
    'ILS' => new C('ILS', 'nuovo siclo israeliano', '₪', '₪', ['one' => 'nuovo siclo israeliano', 'other' => 'nuovi sicli israeliani']),
    ...
    'ITL' => new C('ITL', 'lira italiana', plurals: 'lire italiane'),
    ...
    'MMK' => new C('MMK', 'kyat di Myanmar', narrow: 'K', plurals: 'kyat di Myanmar'),
    ...
    'MRO' => new C('MRO', 'ouguiya della Mauritania (1973–2017)', plurals: 'ouguiya della Mauritania (1973–2017)'),
    'MRU' => new C('MRU', 'ouguiya della Mauritania', plurals: 'ouguiya della Mauritania'),
    ...
    'MVR' => new C('MVR', 'rufiyaa delle Maldive', plurals: 'rufiyaa delle Maldive'),
    ...
    'NIC' => new C('NIC', 'cordoba nicaraguense', plurals: 'cordoba nicaraguense'),
    ...
    'NZD' => new C('NZD', 'dollaro neozelandese', 'NZ$', '$', ['one' => 'dollaro neozelandese', 'other' => 'dollari neozelandesi']),
    ...
    'PHP' => new C('PHP', 'peso filippino', '₱', '₱', ['one' => 'peso filippino', 'other' => 'pesos filippini']),
    ...
    'STD' => new C('STD', 'dobra di Sao Tomé e Principe (1977–2017)', plurals: 'dobra di Sao Tomé e Principe (1977–2017)'),
    'STN' => new C('STN', 'dobra di Sao Tomé e Príncipe', narrow: 'Db', plurals: 'dobra di Sao Tomé e Príncipe'),
    ...
    'SZL' => new C('SZL', 'lilangeni dello Swaziland', plurals: 'lilangeni dello Swaziland'),
    'THB' => new C('THB', 'baht thailandese', '฿', '฿', ['one' => 'baht thailandese', 'other' => 'baht thailandesi']),
    ...
    'VUV' => new C('VUV', 'vatu di Vanuatu', plurals: 'vatu di Vanuatu', minorUnits: 0),
    ...
    'XCD' => new C('XCD', 'dollaro dei Caraibi orientali', 'EC$', '$', ['one' => 'dollaro dei Caraibi orientali', 'other' => 'dollari dei Caraibi orientali']),
