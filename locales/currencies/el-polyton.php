...
return [
    ...
    'EUR' => new C('EUR', 'Εὐρώ', '€', narrow: '€', plurals: 'ευρώ'),
    ...
    'JPY' => new C('JPY', 'Γιὲν Ἰαπωνίας', 'JP¥', narrow: '¥', plurals: 'γιεν Ιαπωνίας', minorUnits: 0),
    ...
    'MXN' => new C('MXN', 'Πέσο Μεξικοῦ', 'MX$', narrow: '$', plurals: 'πέσο Μεξικού'),
    ...
    'THB' => new C('THB', 'Μπὰτ Ταϊλάνδης', '฿', narrow: '฿', plurals: 'μπατ Ταϊλάνδης'),
