...
return [
    ...
    'BYN' => new C('BYN', 'Belarusian Ruble', narrow: 'р.', plurals: ['one' => 'Belarusian ruble', 'other' => 'Belarusian rubles']),
    ...
    'CZK' => new C('CZK', 'Czech Republic Koruna', narrow: 'Kč', plurals: ['one' => 'Czech Republic koruna', 'other' => 'Czech Republic korunas']),
    ...
    'ILS' => new C('ILS', 'Israeli New Sheqel', '₪', narrow: '₪', plurals: ['one' => 'Israeli new sheqel', 'other' => 'Israeli new sheqels']),
    ...
    'NIO' => new C('NIO', 'Córdoba ng Nicaragua', narrow: 'C$', plurals: ['one' => 'córdoba ng Nicaragua', 'other' => 'Nicaraguan córdobas']),
