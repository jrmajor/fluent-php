...
return [
    ...
    'ARS' => new C('ARS', 'Piso ng Argentina', narrow: '$', plurals: ['other' => 'piso ng Argentina']),
    'AUD' => new C('AUD', 'Dolyar ng Australya', 'A$', narrow: '$', plurals: ['one' => 'dolyar ng Australya', 'other' => 'dolyares ng Australya']),
    'AWG' => new C('AWG', 'Florin ng Aruba', plurals: ['other' => 'florin ng Aruba']),
    ...
    'BND' => new C('BND', 'Dolyar ng Brunei', narrow: '$', plurals: ['other' => 'dolyar ng Brunei']),
    ...
    'CLP' => new C('CLP', 'Piso ng Chile', narrow: '$', plurals: ['other' => 'piso ng Chile'], minorUnits: 0),
    ...
    'CUC' => new C('CUC', 'Convertible na Piso ng Cuba', narrow: '$', plurals: ['other' => 'Convertible na piso ng Cuba']),
    'CUP' => new C('CUP', 'Piso ng Cuba', narrow: '$', plurals: ['other' => 'piso ng Cuba']),
    ...
    'KPW' => new C('KPW', 'Won ng Hilagang Korea', narrow: '₩', plurals: ['other' => 'won ng Hilagang Korea']),
    'KRW' => new C('KRW', 'Won ng Timog Korea', '₩', narrow: '₩', plurals: ['other' => 'won ng Timog Korea'], minorUnits: 0),
    ...
    'MXN' => new C('MXN', 'Piso ng Mexico', 'MX$', narrow: '$', plurals: ['other' => 'piso ng Mexico']),
    ...
    'NZD' => new C('NZD', 'Dolyar ng New Zealand', 'NZ$', narrow: '$', plurals: ['other' => 'dolyares ng New Zealand']),
    ...
    'PGK' => new C('PGK', 'Papua New Guinean Kina', plurals: ['other' => 'Papua New Guinean kina']),
    'PHP' => new C('PHP', 'Piso ng Pilipinas', '₱', narrow: '₱', plurals: ['other' => 'piso ng Pilipinas']),
    ...
    'SBD' => new C('SBD', 'Dolyar ng Solomon Islands', narrow: '$', plurals: ['other' => 'dolyar ng Solomon Islands']),
    ...
    'TMT' => new C('TMT', 'Turkmenistani Manat', plurals: ['other' => 'Turkmenistani manat']),
    'TND' => new C('TND', 'Tunisian Dinar', plurals: ['one' => 'Tunisian dinar', 'other' => 'Tunisian dinars'], minorUnits: 3),
    'TOP' => new C('TOP', 'Tongan Paʻanga', narrow: 'T$', plurals: ['other' => 'Tongan paʻanga']),
    ...
    'UYU' => new C('UYU', 'Piso ng Uruguay', narrow: '$', plurals: ['other' => 'piso ng Uruguay']),
    'UZS' => new C('UZS', 'Uzbekistan Som', plurals: ['other' => 'Uzbekistan som']),
    ...
    'WST' => new C('WST', 'Samoan Tala', plurals: ['other' => 'Samoan tala']),
    ...
    'ZAR' => new C('ZAR', 'Rand ng Timog Africa', narrow: 'R', plurals: ['other' => 'rand ng Timog Africa']),
