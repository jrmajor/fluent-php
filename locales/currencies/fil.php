...
return [
    ...
    'AUD' => new C('AUD', 'Dolyar ng Australya', 'A$', '$', ['one' => 'dolyar ng Australya', 'other' => 'dolyares ng Australya']),
    ...
    'BRL' => new C('BRL', 'Real ng Barzil', 'R$', 'R$', ['one' => 'real ng Brazil', 'other' => 'reals ng Brazil']),
    ...
    'CAD' => new C('CAD', 'Dolyar ng Canada', 'CA$', '$', ['one' => 'dolyar ng Canada', 'other' => 'Dolyares ng Canada']),
    ...
    'HKD' => new C('HKD', 'Dolyar ng Hong Kong', 'HK$', '$', ['one' => 'dolyar ng Hong Kong', 'other' => 'dolyares ng Hong Kong']),
    ...
    'ILS' => new C('ILS', 'New Shekel ng Israel', '₪', '₪', ['one' => 'new shekel ng Israel', 'other' => 'new shekels ng Israel']),
    ...
    'KRW' => new C('KRW', 'Won ng Timog Korea', '₩', '₩', 'won ng Timog Korea', 0),
    ...
    'MXN' => new C('MXN', 'Piso ng Mexico', 'MX$', '$', 'piso ng Mexico'),
    ...
    'NZD' => new C('NZD', 'Dolyar ng New Zealand', 'NZ$', '$', 'dolyares ng New Zealand'),
    ...
    'PHP' => new C('PHP', 'Piso ng Pilipinas', '₱', '₱', 'piso ng Pilipinas'),
    ...
    'THB' => new C('THB', 'Thai Baht', '฿', '฿', 'Thai baht'),
    ...
    'TWD' => new C('TWD', 'Dolyar ng New Taiwan', 'NT$', 'NT$', ['one' => 'dolyar ng New Taiwan', 'other' => 'dolyares ng New Taiwan']),
    ...
    'USD' => new C('USD', 'Dolyar ng US', '$', '$', ['one' => 'dolyar ng US', 'other' => 'dolyares ng US']),
    ...
    'XCD' => new C('XCD', 'Dolyar ng Silangang Caribbean', 'EC$', '$', ['one' => 'dolyar ng Silangang Caribbean', 'other' => 'dolyares ng Silangang Caribbean']),
