...
return [
    ...
    'ARS' => new C('ARS', 'Piso ng Argentina', narrow: '$', plurals: 'piso ng Argentina'),
    'AUD' => new C('AUD', 'Dolyar ng Australya', 'A$', narrow: '$', plurals: ['one' => 'dolyar ng Australya', 'other' => 'dolyares ng Australya']),
    'AWG' => new C('AWG', 'Florin ng Aruba', plurals: 'florin ng Aruba'),
    ...
    'BND' => new C('BND', 'Dolyar ng Brunei', narrow: '$', plurals: 'dolyar ng Brunei'),
    ...
    'CLP' => new C('CLP', 'Piso ng Chile', narrow: '$', plurals: 'piso ng Chile', minorUnits: 0),
    ...
    'CUC' => new C('CUC', 'Convertible na Piso ng Cuba', narrow: '$', plurals: 'Convertible na piso ng Cuba'),
    'CUP' => new C('CUP', 'Piso ng Cuba', narrow: '$', plurals: 'piso ng Cuba'),
    ...
    'KRW' => new C('KRW', 'Won ng Timog Korea', '₩', narrow: '₩', plurals: 'won ng Timog Korea', minorUnits: 0),
    ...
    'MXN' => new C('MXN', 'Piso ng Mexico', 'MX$', narrow: '$', plurals: 'piso ng Mexico'),
    ...
    'NZD' => new C('NZD', 'Dolyar ng New Zealand', 'NZ$', narrow: '$', plurals: 'dolyares ng New Zealand'),
    ...
    'PHP' => new C('PHP', 'Piso ng Pilipinas', '₱', narrow: '₱', plurals: 'piso ng Pilipinas'),
    ...
    'SBD' => new C('SBD', 'Dolyar ng Solomon Islands', narrow: '$', plurals: 'dolyar ng Solomon Islands'),
    ...
    'UYU' => new C('UYU', 'Piso ng Uruguay', narrow: '$', plurals: 'piso ng Uruguay'),
    'UZS' => new C('UZS', 'Uzbekistan Som', plurals: 'Uzbekistan som'),
    ...
    'ZAR' => new C('ZAR', 'Rand ng Timog Africa', narrow: 'R', plurals: 'rand ng Timog Africa'),
