...
return [
    ...
    'AUD' => new C('AUD', 'Dolar Australia', 'AU$', '$', 'Dolar Australia'),
    ...
    'CNY' => new C('CNY', 'Yuan Tiongkok', 'CN¥', '¥', 'Yuan Tiongkok'),
    ...
    'ILS' => new C('ILS', 'Shekel Baru Israel', '₪', '₪', 'Shekel Baru Israel'),
    'INR' => new C('INR', 'Rupee India', 'Rs', '₹', 'Rupee India'),
    ...
    'NZD' => new C('NZD', 'Dolar Selandia Baru', 'NZ$', '$', 'Dolar Selandia Baru'),
    ...
    'THB' => new C('THB', 'Baht Thailand', '฿', '฿', 'Baht Thailand'),
    ...
    'TWD' => new C('TWD', 'Dolar Baru Taiwan', 'NT$', 'NT$', 'Dolar Baru Taiwan'),
    ...
    'XCD' => new C('XCD', 'Dolar Karibia Timur', 'EC$', '$', 'Dolar Karibia Timur'),
