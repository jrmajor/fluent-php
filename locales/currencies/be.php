...
return [
    ...
    'BOB' => new C('BOB', 'балівіяна', narrow: 'Bs', plurals: ['one' => 'балівіяна', 'few' => 'балівіяна', 'many' => 'балівіяна', 'other' => 'балівіяна']),
    ...
    'BYN' => new C('BYN', 'беларускі рубель', 'Br', narrow: 'Br', plurals: ['one' => 'беларускі рубель', 'few' => 'беларускія рублі', 'many' => 'беларускіх рублёў', 'other' => 'беларускага рубля']),
    ...
    'EUR' => new C('EUR', 'еўра', '€', narrow: '€', plurals: ['one' => 'еўра', 'few' => 'еўра', 'many' => 'еўра', 'other' => 'еўра']),
    ...
    'STN' => new C('STN', 'добра Сан-Тамэ і Прынсіпі', narrow: 'Db', plurals: ['one' => 'добра Сан-Тамэ і Прынсіпі', 'few' => 'добры Сан-Тамэ і Прынсіпі', 'many' => 'добраў Сан-Тамэ і Прынсіпі', 'other' => 'добры Сан-Тамэ і Прынсіпі']),
