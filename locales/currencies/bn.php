...
return [
    ...
    'AFN' => new C('AFN', 'আফগান আফগানি', plurals: ['one' => 'আফগান আফগানি', 'other' => 'আফগান আফগানি']),
    'ALK' => new C('ALK'),
    'ALL' => new C('ALL', 'আলবেনিয়ান লেক', plurals: ['one' => 'আলবেনিয়ান লেক', 'other' => 'আলবেনিয়ান লেক']),
    'AMD' => new C('AMD', 'আরমেনিয়ান দ্রাম', plurals: ['one' => 'আরমেনিয়ান দ্রাম', 'other' => 'আরমেনিয়ান দ্রাম']),
    ...
    'AOA' => new C('AOA', 'এ্যাঙ্গোলান কওয়ানজা', plurals: ['one' => 'এ্যাঙ্গোলান কওয়ানজা', 'other' => 'এ্যাঙ্গোলান কওয়ানজা']),
    ...
    'ARS' => new C('ARS', 'আর্জেন্টিনা পেসো', plurals: ['one' => 'আর্জেন্টিনা পেসো', 'other' => 'আর্জেন্টিনা পেসো']),
    'ATS' => new C('ATS', 'অস্ট্রিয়ান শিলিং'),
    'AUD' => new C('AUD', 'অস্ট্রেলিয়ান ডলার', 'A$', plurals: ['one' => 'অস্ট্রেলিয়ান ডলার', 'other' => 'অস্ট্রেলিয়ান ডলার']),
    'AWG' => new C('AWG', 'আরুবা গিল্ডার', plurals: ['one' => 'আরুবা গিল্ডার', 'other' => 'আরুবা গিল্ডার']),
    'AZM' => new C('AZM', 'আজারবাইজান মানাত (১৯৯৩–২০০৬)'),
    'AZN' => new C('AZN', 'আজারবাইজান মানাত', plurals: ['one' => 'আজারবাইজান মানাত', 'other' => 'আজারবাইজান মানাত']),
    'BAD' => new C('BAD', 'বসনিয়া এবং হার্জেগোভিনা দিনার'),
    'BAM' => new C('BAM', 'বসনিয়া এবং হার্জেগোভিনা বিনিমেয় মার্ক', plurals: ['one' => 'বসনিয়া এবং হার্জেগোভিনা বিনিমেয় মার্ক', 'other' => 'বসনিয়া এবং হার্জেগোভিনা বিনিমেয় মার্ক']),
    'BAN' => new C('BAN'),
    'BBD' => new C('BBD', 'বার্বেডোজ ডলার', plurals: ['one' => 'বার্বেডোজ ডলার', 'other' => 'বার্বেডোজ ডলার']),
    ...
    'BMD' => new C('BMD', 'বারমিউডান ডলার', plurals: ['one' => 'বারমিউডান ডলার', 'other' => 'বারমিউডান ডলার']),
    'BND' => new C('BND', 'ব্রুনেই ডলার', plurals: ['one' => 'ব্রুনেই ডলার', 'other' => 'ব্রুনেই ডলার']),
    'BOB' => new C('BOB', 'বলিভিয়ানো', plurals: ['one' => 'বলিভিয়ানো', 'other' => 'বলিভিয়ানো']),
    'BOL' => new C('BOL'),
    ...
    'BRL' => new C('BRL', 'ব্রাজিলিয়ান রিয়েল', 'R$', plurals: ['one' => 'ব্রাজিলিয়ান রিয়েল', 'other' => 'ব্রাজিলিয়ান রিয়েল']),
    'BRN' => new C('BRN', 'ব্রাজিলিয়ান ক্রুজেইডো নোভো'),
    'BRR' => new C('BRR', 'ব্রাজিলিয়ান ক্রুজেয়রো'),
    'BRZ' => new C('BRZ'),
    'BSD' => new C('BSD', 'বাহামিয়ান ডলার', plurals: ['one' => 'বাহামিয়ান ডলার', 'other' => 'বাহামিয়ান ডলার']),
    'BTN' => new C('BTN', 'ভুটানি এনগুল্ট্রুম', plurals: ['one' => 'ভুটানি এনগুল্ট্রুম', 'other' => 'ভুটানি এনগুল্ট্রুম']),
    'BUK' => new C('BUK', 'বর্মি কিয়াৎ'),
    'BWP' => new C('BWP', 'বতসোয়ানা পুলা', plurals: ['one' => 'বতসোয়ানা পুলা', 'other' => 'বতসোয়ানা পুলা']),
    'BYB' => new C('BYB', 'বেলারুশিয়ান নিউ রুবেল (১৯৯৪–১৯৯৯)'),
    'BYN' => new C('BYN', 'বেলারুশিয়ান রুবেল', plurals: ['one' => 'বেলারুশিয়ান রুবেল', 'other' => 'বেলারুশিয়ান রুবেল']),
    'BYR' => new C('BYR', 'বেলারুশিয়ান রুবেল (2000–2016)', plurals: ['one' => 'বেলারুশিয়ান রুবেল (2000–2016)', 'other' => 'বেলারুশিয়ান রুবেল (2000–2016)']),
    'BZD' => new C('BZD', 'বেলিজ ডলার', plurals: ['one' => 'বেলিজ ডলার', 'other' => 'বেলিজ ডলার']),
    'CAD' => new C('CAD', 'কানাডিয়ান ডলার', 'CA$', plurals: ['one' => 'কানাডিয়ান ডলার', 'other' => 'কানাডিয়ান ডলার']),
    ...
    'CLP' => new C('CLP', 'চিলি পেসো', plurals: ['one' => 'চিলি পেসো', 'other' => 'চিলি পেসো'], minorUnits: 0),
    'CNH' => new C('CNH', 'চাইনিজ ইউয়ান (অফশোর)', plurals: ['one' => 'চাইনিজ ইউয়ান (অফশোর)', 'other' => 'চাইনিজ ইউয়ান (অফশোর)']),
    'CNX' => new C('CNX'),
    'CNY' => new C('CNY', 'চীনা য়ুয়ান', 'CN¥', plurals: ['one' => 'চীনা য়ুয়ান', 'other' => 'চীনা য়ুয়ান']),
    'COP' => new C('COP', 'কলোম্বিয়ান পেসো', plurals: ['one' => 'কলোম্বিয়ান পেসো', 'other' => 'কলোম্বিয়ান পেসো']),
    'COU' => new C('COU', 'উনিদাদ দি ভ্যালোর রিয়েল'),
    'CRC' => new C('CRC', 'কোস্টা রিকা কোলোন', plurals: ['one' => 'কোস্টা রিকা কোলোন', 'other' => 'কোস্টা রিকা কোলোন']),
    'CSD' => new C('CSD', 'প্রাচীন সারবিয়ান দিনার'),
    'CSK' => new C('CSK', 'চেকোস্লোভাক হার্ড কোরুনা'),
    'CUC' => new C('CUC', 'কিউবান রূপান্তরযোগ্য পেসো', plurals: ['one' => 'কিউবান রূপান্তরযোগ্য পেসো', 'other' => 'কিউবান রূপান্তরযোগ্য পেসো']),
    'CUP' => new C('CUP', 'কিউবান পেসো', plurals: ['one' => 'কিউবান পেসো', 'other' => 'কিউবান পেসো']),
    'CVE' => new C('CVE', 'কেপ ভার্দে এসকুডো', plurals: ['one' => 'কেপ ভার্দে এসকুডো', 'other' => 'কেপ ভার্দে এসকুডো']),
    'CYP' => new C('CYP', 'সাইপ্রাস পাউন্ড'),
    'CZK' => new C('CZK', 'চেক প্রজাতন্ত্র কোরুনা', plurals: ['one' => 'চেক প্রজাতন্ত্র কোরুনা', 'other' => 'চেক প্রজাতন্ত্র কোরুনা']),
    ...
    'DKK' => new C('DKK', 'ড্যানিশ ক্রোন', plurals: ['one' => 'ড্যানিশ ক্রোন', 'other' => 'ড্যানিশ ক্রৌন']),
    'DOP' => new C('DOP', 'ডোমিনিকান পেসো', plurals: ['one' => 'ডোমিনিকান পেসো', 'other' => 'ডোমিনিকান পেসো']),
    ...
    'EGP' => new C('EGP', 'মিশরীয় পাউন্ড', plurals: ['one' => 'মিশরীয় পাউন্ড', 'other' => 'মিশরীয় পাউন্ড']),
    ...
    'ESP' => new C('ESP', 'স্প্যানিশ পেসেতা'),
    'ETB' => new C('ETB', 'ইথিওপিয়ান বির', plurals: ['one' => 'ইথিওপিয়ান বির', 'other' => 'ইথিওপিয়ান বির']),
    'EUR' => new C('EUR', 'ইউরো', '€', plurals: ['one' => 'ইউরো', 'other' => 'ইউরো']),
    'FIM' => new C('FIM', 'ফিনিস মার্কা'),
    'FJD' => new C('FJD', 'ফিজি ডলার', plurals: ['one' => 'ফিজি ডলার', 'other' => 'ফিজি ডলার']),
    'FKP' => new C('FKP', 'ফকল্যান্ড দ্বীপপুঞ্জ পাউন্ড', plurals: ['one' => 'ফকল্যান্ড দ্বীপপুঞ্জ পাউন্ড', 'other' => 'ফকল্যান্ড দ্বীপপুঞ্জ পাউন্ড']),
    'FRF' => new C('FRF', 'ফরাসি ফ্রাঙ্ক'),
    'GBP' => new C('GBP', 'ব্রিটিশ পাউন্ড', '£', plurals: ['one' => 'ব্রিটিশ পাউন্ড', 'other' => 'ব্রিটিশ পাউন্ড']),
    'GEK' => new C('GEK', 'জর্জিয়ান কুপন লারিট'),
    'GEL' => new C('GEL', 'জর্জিয়ান লারি', plurals: ['one' => 'জর্জিয়ান লারি', 'other' => 'জর্জিয়ান লারি']),
    'GHC' => new C('GHC', 'ঘানা সেডি (১৯৭৯–২০০৭)'),
    'GHS' => new C('GHS', 'ঘানা সেডি', plurals: ['one' => 'ঘানা সেডি', 'other' => 'ঘানা সেডি']),
    'GIP' => new C('GIP', 'জিব্রাল্টার পাউন্ড', plurals: ['one' => 'জিব্রাল্টার পাউন্ড', 'other' => 'জিব্রাল্টার পাউন্ড']),
    'GMD' => new C('GMD', 'গাম্বিয়া ডালাসি', plurals: ['one' => 'গাম্বিয়া ডালাসি', 'other' => 'গাম্বিয়া ডালাসি']),
    'GNF' => new C('GNF', 'গিনি ফ্রাঙ্ক', plurals: ['one' => 'গিনি ফ্রাঙ্ক', 'other' => 'গিনি ফ্রাঙ্ক'], minorUnits: 0),
    'GNS' => new C('GNS', 'গিনি সাইলি'),
    'GQE' => new C('GQE', 'ইকুয়েটোরিয়াল গিনি ইকুয়িলি'),
    'GRD' => new C('GRD', 'গ্রীক দ্রাচমা'),
    'GTQ' => new C('GTQ', 'গুয়াতেমালা কুয়েৎজাল', plurals: ['one' => 'গুয়াতেমালা কুয়েৎজাল', 'other' => 'গুয়াতেমালা কুয়েৎজাল']),
    'GWE' => new C('GWE', 'পর্তুগিজ গিনি এসকুডো'),
    'GWP' => new C('GWP', 'গিনি বিসাউ পেসো'),
    'GYD' => new C('GYD', 'গাইয়েনা ডলার', plurals: ['one' => 'গাইয়েনা ডলার', 'other' => 'গাইয়েনা ডলার']),
    'HKD' => new C('HKD', 'হংকং ডলার', 'HK$', plurals: ['one' => 'হংকং ডলার', 'other' => 'হংকং ডলার']),
    'HNL' => new C('HNL', 'হন্ডুরাস লেম্পিরা', plurals: ['one' => 'হন্ডুরাস লেম্পিরা', 'other' => 'হন্ডুরাস লেম্পিরা']),
    'HRD' => new C('HRD', 'ক্রোয়েশিয়ান দিনার'),
    'HRK' => new C('HRK', 'ক্রোয়েশিয়ান কুনা', plurals: ['one' => 'ক্রোয়েশিয়ান কুনা', 'other' => 'ক্রোয়েশিয়ান কুনা']),
    'HTG' => new C('HTG', 'হাইতি গৌর্দে', plurals: ['one' => 'হাইতি গৌর্দে', 'other' => 'হাইতি গৌর্দে']),
    'HUF' => new C('HUF', 'হাঙ্গেরিয়ান ফোরিন্ট', plurals: ['one' => 'হাঙ্গেরিয়ান ফোরিন্ট', 'other' => 'হাঙ্গেরিয়ান ফোরিন্ট']),
    'IDR' => new C('IDR', 'ইন্দোনেশিয়ান রুপিয়াহ', plurals: ['one' => 'ইন্দোনেশিয়ান রুপিয়াহ', 'other' => 'ইন্দোনেশিয়ান রুপিয়াহ']),
    'IEP' => new C('IEP', 'ইরিশ পাউন্ড'),
    'ILP' => new C('ILP', 'ইস্রাইলি পাউন্ড'),
    'ILR' => new C('ILR'),
    'ILS' => new C('ILS', 'ইস্রাইলি নতুন শেকেল', '₪', plurals: ['one' => 'ইস্রাইলি নতুন শেকেল', 'other' => 'ইস্রাইলি নতুন শেকেল']),
    'INR' => new C('INR', 'ভারতীয় রুপি', '₹', plurals: ['one' => 'ভারতীয় রুপি', 'other' => 'ভারতীয় রুপি']),
    ...
    'ISJ' => new C('ISJ'),
    'ISK' => new C('ISK', 'আইসল্যান্ডীয় ক্রোনা', plurals: ['one' => 'আইসল্যান্ডীয় ক্রোনা', 'other' => 'আইসল্যান্ড ক্রৌন'], minorUnits: 0),
    'ITL' => new C('ITL', 'ইতালীয় লিরা'),
    'JMD' => new C('JMD', 'জামাইকান ডলার', plurals: ['one' => 'জামাইকান ডলার', 'other' => 'জামাইকান ডলার']),
    'JOD' => new C('JOD', 'জর্ডানিয়ান দিনার', plurals: ['one' => 'জর্ডানিয়ান দিনার', 'other' => 'জর্ডানিয়ান দিনার'], minorUnits: 3),
    'JPY' => new C('JPY', 'জাপানি ইয়েন', 'JP¥', plurals: ['one' => 'জাপানি ইয়েন', 'other' => 'জাপানি ইয়েন'], minorUnits: 0),
    ...
    'KHR' => new C('KHR', 'কম্বোডিয়ান রিয়েল', plurals: ['one' => 'কম্বোডিয়ান রিয়েল', 'other' => 'কম্বোডিয়ান রিয়েল']),
    'KMF' => new C('KMF', 'কম্বোরো ফ্রাঙ্ক', plurals: ['one' => 'কমোরিয়ান ফ্রাঙ্ক', 'other' => 'কমোরিয়ান ফ্রাঙ্ক'], minorUnits: 0),
    'KPW' => new C('KPW', 'উত্তর কোরিয়ার ওন', plurals: ['one' => 'উত্তর কোরিয়ার ওন', 'other' => 'উত্তর কোরিয়ার ওন']),
    'KRH' => new C('KRH'),
    'KRO' => new C('KRO'),
    'KRW' => new C('KRW', 'দক্ষিণ কোরিয়ান ওন', '₩', plurals: ['one' => 'দক্ষিণ কোরিয়ান ওন', 'other' => 'দক্ষিণ কোরিয়ান ওন'], minorUnits: 0),
    'KWD' => new C('KWD', 'কুয়েতি দিনার', plurals: ['one' => 'কুয়েতি দিনার', 'other' => 'কুয়েতি দিনার'], minorUnits: 3),
    'KYD' => new C('KYD', 'কেম্যান দ্বীপপুঞ্জের ডলার', plurals: ['one' => 'কেম্যান দ্বীপপুঞ্জের ডলার', 'other' => 'কেম্যান দ্বীপপুঞ্জের ডলার']),
    'KZT' => new C('KZT', 'কাজাখাস্তানি টেঙ্গে', plurals: ['one' => 'কাজাখাস্তানি টেঙ্গে', 'other' => 'কাজাখাস্তানি টেঙ্গে']),
    'LAK' => new C('LAK', 'লেউশান কিপ', plurals: ['one' => 'লেউশান কিপ', 'other' => 'লেউশান কিপ']),
    'LBP' => new C('LBP', 'লেবানিজ পাউন্ড', plurals: ['one' => 'লেবানিজ পাউন্ড', 'other' => 'লেবানিজ পাউন্ড']),
    'LKR' => new C('LKR', 'শ্রীলঙ্কান রুপি', plurals: ['one' => 'শ্রীলঙ্কান রুপি', 'other' => 'শ্রীলঙ্কান রুপি']),
    'LRD' => new C('LRD', 'লিবেরিয়ান ডলার', plurals: ['one' => 'লিবেরিয়ান ডলার', 'other' => 'লিবেরিয়ান ডলার']),
    'LSL' => new C('LSL', 'লেসুটু লোটি'),
    'LTL' => new C('LTL', 'লিথুইনিয়ান লিটা', plurals: ['one' => 'লিথুইনিয়ান লিটা', 'other' => 'লিথুইনিয়ান লিটা']),
    ...
    'LVL' => new C('LVL', 'ল্যাটভিয়ান ল্যাট্‌স', plurals: ['one' => 'ল্যাটভিয়ান ল্যাট্‌স', 'other' => 'ল্যাটভিয়ান ল্যাট্‌স']),
    ...
    'MGA' => new C('MGA', 'মাদাগাস্কার আরিয়ারি', plurals: ['one' => 'মাদাগাস্কার আরিয়ারি', 'other' => 'মাদাগাস্কার আরিয়ারি']),
    ...
    'MMK' => new C('MMK', 'মায়ানমার কিয়াত', plurals: ['one' => 'মায়ানমার কিয়াত', 'other' => 'মায়ানমার কিয়াত']),
    'MNT' => new C('MNT', 'মঙ্গোলিয়ান তুগরিক', plurals: ['one' => 'মঙ্গোলিয়ান তুগরিক', 'other' => 'মঙ্গোলিয়ান তুগরিক']),
    ...
    'MUR' => new C('MUR', 'মৌরিতানিয়ান রুপি', plurals: ['one' => 'মৌরিতানিয়ান রুপি', 'other' => 'মৌরিতানিয়ান রুপি']),
    'MVP' => new C('MVP'),
    ...
    'MXN' => new C('MXN', 'ম্যাক্সিকান পেসো', 'MX$', plurals: ['one' => 'ম্যাক্সিকান পেসো', 'other' => 'ম্যাক্সিকান পেসো']),
    'MXP' => new C('MXP', 'ম্যাক্সিকান সিলভার পেসো (১৮৬১–১৯৯২)'),
    'MXV' => new C('MXV', 'মেক্সিকান উনিদাদ দি ইনভার্সান (UDI)'),
    'MYR' => new C('MYR', 'মালয়েশিয়ান রিঙ্গিৎ', plurals: ['one' => 'মালয়েশিয়ান রিঙ্গিৎ', 'other' => 'মালয়েশিয়ান রিঙ্গিৎ']),
    ...
    'NAD' => new C('NAD', 'নামিবিয়া ডলার', plurals: ['one' => 'নামিবিয়া ডলার', 'other' => 'নামিবিয়া ডলার']),
    'NGN' => new C('NGN', 'নাইজেরিয়ান নায়রা', plurals: ['one' => 'নাইজেরিয়ান নায়রা', 'other' => 'নাইজেরিয়ান নায়রা']),
    'NIC' => new C('NIC', 'নিকারাগুয়ান কর্ডোবা (১৯৮৮–১৯৯১)'),
    'NIO' => new C('NIO', 'নিকারাগুয়ান কর্ডোবা', plurals: ['one' => 'নিকারাগুয়ান কর্ডোবা', 'other' => 'নিকারাগুয়ান কর্ডোবা']),
    'NLG' => new C('NLG', 'নেদারল্যান্ড গুল্ডের'),
    'NOK' => new C('NOK', 'নরওয়েজিয়ান ক্রোন', plurals: ['one' => 'নরওয়েজিয়ান ক্রোন', 'other' => 'নরওয়েজিয়ান ক্রোনার']),
    'NPR' => new C('NPR', 'নেপালি রুপি', plurals: ['one' => 'নেপালি রুপি', 'other' => 'নেপালি রুপি']),
    'NZD' => new C('NZD', 'নিউজিল্যান্ড ডলার', 'NZ$', plurals: ['one' => 'নিউজিল্যান্ড ডলার', 'other' => 'নিউজিল্যান্ড ডলার']),
    ...
    'PHP' => new C('PHP', 'ফিলিপাইন পেসো', plurals: ['one' => 'ফিলিপাইন পেসো', 'other' => 'ফিলিপাইন পেসো']),
    'PKR' => new C('PKR', 'পাকিস্তানি রুপি', plurals: ['one' => 'পাকিস্তানি রুপি', 'other' => 'পাকিস্তানি রুপি']),
    'PLN' => new C('PLN', 'পোলিশ জ্লোটি', plurals: ['one' => 'পোলিশ জ্লোটি', 'other' => 'পোলিশ জ্লোটি']),
    'PLZ' => new C('PLZ', 'পোলিশ জ্লোটি (১৯৫০–১৯৯৫)'),
    'PTE' => new C('PTE', 'পর্তুগিজ এসকুডো'),
    'PYG' => new C('PYG', 'প্যারাগুয়ান গুয়ারানি', plurals: ['one' => 'প্যারাগুয়ান গুয়ারানি', 'other' => 'প্যারাগুয়ান গুয়ারানি'], minorUnits: 0),
    ...
    'RON' => new C('RON', 'রুমানিয়া লেয়ু', plurals: ['one' => 'রুমানিয়া লেয়ু', 'other' => 'রুমানিয়া লেয়ু']),
    'RSD' => new C('RSD', 'সারবিয়ান দিনার', plurals: ['one' => 'সারবিয়ান দিনার', 'other' => 'সারবিয়ান দিনার']),
    'RUB' => new C('RUB', 'রাশিয়ান রুবেল', plurals: ['one' => 'রাশিয়ান রুবেল', 'other' => 'রাশিয়ান রুবেল']),
    'RUR' => new C('RUR', 'রাশিয়ান রুবল (১৯৯১–১৯৯৮)'),
    'RWF' => new C('RWF', 'রুয়ান্ডান ফ্রাঙ্ক', plurals: ['one' => 'রুয়ান্ডান ফ্রাঙ্ক', 'other' => 'রুয়ান্ডান ফ্রাঙ্ক'], minorUnits: 0),
    'SAR' => new C('SAR', 'সৌদি রিয়াল', plurals: ['one' => 'সৌদি রিয়াল', 'other' => 'সৌদি রিয়াল']),
    'SBD' => new C('SBD', 'সলোমন দ্বীপপুঞ্জ ডলার', plurals: ['one' => 'সলোমন দ্বীপপুঞ্জ ডলার', 'other' => 'সলোমন দ্বীপপুঞ্জ ডলার']),
    ...
    'SEK' => new C('SEK', 'সুইডিশ ক্রোনা', plurals: ['one' => 'সুইডিশ ক্রোনা', 'other' => 'সুইডিশ ক্রোনা']),
    'SGD' => new C('SGD', 'সিঙ্গাপুর ডলার', plurals: ['one' => 'সিঙ্গাপুর ডলার', 'other' => 'সিঙ্গাপুর ডলার']),
    'SHP' => new C('SHP', 'সেন্ট হেলেনা পাউন্ড', plurals: ['one' => 'সেন্ট হেলেনা পাউন্ড', 'other' => 'সেন্ট হেলেনা পাউন্ড']),
    ...
    'SRD' => new C('SRD', 'সুরিনাম ডলার', plurals: ['one' => 'সুরিনাম ডলার', 'other' => 'সুরিনাম ডলার']),
    'SRG' => new C('SRG', 'সুরিনাম গিল্ডার'),
    'SSP' => new C('SSP', 'দক্ষিণ সুদানি পাউন্ড', plurals: ['one' => 'দক্ষিণ সুদানি পাউন্ড', 'other' => 'দক্ষিণ সুদানি পাউন্ড']),
    ...
    'STN' => new C('STN', 'সাও টোমে এবং প্রিন্সিপে ডোবরা', plurals: ['one' => 'সাও টোমে এবং প্রিন্সিপে ডোবরা', 'other' => 'সাও টোমে এবং প্রিন্সিপে ডোবরা']),
    'SUR' => new C('SUR', 'সোভিয়েত রুবল'),
    'SVC' => new C('SVC', 'এল স্যালভোডোর কোলোন'),
    'SYP' => new C('SYP', 'সিরিয়ান পাউন্ড', plurals: ['one' => 'সিরিয়ান পাউন্ড', 'other' => 'সিরিয়ান পাউন্ড']),
    ...
    'TOP' => new C('TOP', 'টোঙ্গা পা’আঙ্গা', plurals: ['one' => 'টোঙ্গা পা’আঙ্গা', 'other' => 'টোঙ্গা পা’আঙ্গা']),
    'TPE' => new C('TPE', 'তিমুর এসকুডো'),
    'TRL' => new C('TRL', 'প্রাচীন তুর্কি লিরা'),
    'TRY' => new C('TRY', 'তুর্কি লিরা', plurals: ['one' => 'তুর্কি লিরা', 'other' => 'তুর্কি লিরা']),
    'TTD' => new C('TTD', 'ত্রিনিদাদ এবং টোবাগো ডলার', plurals: ['one' => 'ত্রিনিদাদ এবং টোবাগো ডলার', 'other' => 'ত্রিনিদাদ এবং টোবাগো ডলার']),
    'TWD' => new C('TWD', 'নতুন তাইওয়ান ডলার', 'NT$', plurals: ['one' => 'নতুন তাইওয়ান ডলার', 'other' => 'নতুন তাইওয়ান ডলার']),
    'TZS' => new C('TZS', 'তাঞ্জনিয়া শিলিং', plurals: ['one' => 'তাঞ্জনিয়া শিলিং', 'other' => 'তাঞ্জনিয়া শিলিং']),
    'UAH' => new C('UAH', 'ইউক্রেইন হৃভনিয়া', plurals: ['one' => 'ইউক্রেইন হৃভনিয়া', 'other' => 'ইউক্রেইন হৃভনিয়া']),
    ...
    'USD' => new C('USD', 'মার্কিন ডলার', 'US$', plurals: ['one' => 'মার্কিন ডলার', 'other' => 'মার্কিন ডলার']),
    ...
    'UYU' => new C('UYU', 'উরুগুয়ে পেসো', plurals: ['one' => 'উরুগুয়ে পেসো', 'other' => 'উরুগুয়ে পেসো']),
    ...
    'VEF' => new C('VEF', 'ভেনিজুয়েলীয় বলিভার (২০০৮–২০১৮)', plurals: ['one' => 'ভেনিজুয়েলীয় বলিভার (২০০৮–২০১৮)', 'other' => 'ভেনিজুয়েলীয় বলিভার (২০০৮–২০১৮)']),
    'VES' => new C('VES', 'ভেনিজুয়েলীয় বলিভার', plurals: ['one' => 'ভেনিজুয়েলীয় বলিভার', 'other' => 'ভেনিজুয়েলীয় বলিভার']),
    'VND' => new C('VND', 'ভিয়েতনামি ডঙ্গ', '₫', plurals: ['one' => 'ভিয়েতনামি ডঙ্গ', 'other' => 'ভিয়েতনামি ডঙ্গ'], minorUnits: 0),
    'VNN' => new C('VNN'),
    ...
    'XBC' => new C('XBC'),
    'XBD' => new C('XBD'),
    'XCD' => new C('XCD', 'পূর্ব ক্যারাবিয়ান ডলার', 'EC$', plurals: ['one' => 'পূর্ব ক্যারাবিয়ান ডলার', 'other' => 'পূর্ব ক্যারাবিয়ান ডলার']),
    'XDR' => new C('XDR'),
    'XEU' => new C('XEU', 'ইউরোপীয় মুদ্রা একক'),
    'XFO' => new C('XFO', 'ফরাসি গোল্ড ফ্রাঙ্ক'),
    'XFU' => new C('XFU', 'ফরাসি ইউআইসি - ফ্রাঙ্ক'),
    'XOF' => new C('XOF', 'পশ্চিম আফ্রিকান [CFA] ফ্র্যাঙ্ক', 'F CFA', plurals: ['one' => 'পশ্চিম আফ্রিকান [CFA] ফ্র্যাঙ্ক', 'other' => 'পশ্চিম আফ্রিকান [CFA] ফ্র্যাঙ্ক'], minorUnits: 0),
    ...
    'ZAR' => new C('ZAR', 'দক্ষিণ আফ্রিকান রেন্ড', plurals: ['one' => 'দক্ষিণ আফ্রিকান রেন্ড', 'other' => 'দক্ষিণ আফ্রিকান রেন্ড']),
    'ZMK' => new C('ZMK', 'জাম্বিয়ান কওয়াচা (১৯৬৮–২০১২)'),
    'ZMW' => new C('ZMW', 'জাম্বিয়ান কওয়াচা', plurals: ['one' => 'জাম্বিয়ান কওয়াচা', 'other' => 'জাম্বিয়ান কওয়াচা']),
