...
return [
    ...
    'AFN' => new C('AFN', 'afghani', plurals: ['one' => 'afghani', 'other' => 'afghani']),
    'ALK' => new C('ALK'),
    'ALL' => new C('ALL', 'lek albanese', plurals: ['one' => 'lek albanese', 'other' => 'lekë albanesi']),
    'AMD' => new C('AMD', 'dram armeno', plurals: ['one' => 'dram armeno', 'other' => 'dram armeni']),
    ...
    'AOA' => new C('AOA', 'kwanza angolano', plurals: ['one' => 'kwanza angolano', 'other' => 'kwanzas angolani']),
    ...
    'ARS' => new C('ARS', 'peso argentino', plurals: ['one' => 'peso argentino', 'other' => 'pesos argentini']),
    'ATS' => new C('ATS', 'scellino austriaco'),
    'AUD' => new C('AUD', 'dollaro australiano', 'A$', plurals: ['one' => 'dollaro australiano', 'other' => 'dollari australiani']),
    'AWG' => new C('AWG', 'fiorino di Aruba', plurals: ['one' => 'fiorino di Aruba', 'other' => 'fiorini di Aruba']),
    'AZM' => new C('AZM', 'manat azero (1993–2006)'),
    'AZN' => new C('AZN', 'manat azero', plurals: ['one' => 'manat azero', 'other' => 'manat azeri']),
    'BAD' => new C('BAD', 'dinar Bosnia-Herzegovina'),
    'BAM' => new C('BAM', 'marco convertibile della Bosnia-Herzegovina', plurals: ['one' => 'marco convertibile della Bosnia-Herzegovina', 'other' => 'marchi convertibili della Bosnia-Herzegovina']),
    'BAN' => new C('BAN'),
    'BBD' => new C('BBD', 'dollaro di Barbados', plurals: ['one' => 'dollaro di Barbados', 'other' => 'dollari di Barbados']),
    'BDT' => new C('BDT', 'taka bangladese', plurals: ['one' => 'taka bengalese', 'other' => 'taka bengalesi']),
    ...
    'BMD' => new C('BMD', 'dollaro delle Bermuda', plurals: ['one' => 'dollaro delle Bermuda', 'other' => 'dollari delle Bermuda']),
    'BND' => new C('BND', 'dollaro del Brunei', plurals: ['one' => 'dollaro del Brunei', 'other' => 'dollari del Brunei']),
    'BOB' => new C('BOB', 'boliviano', plurals: ['one' => 'boliviano', 'other' => 'boliviani']),
    'BOL' => new C('BOL'),
    ...
    'BRL' => new C('BRL', 'real brasiliano', plurals: ['one' => 'real brasiliano', 'other' => 'real brasiliani']),
    'BRN' => new C('BRN', 'cruzado novo brasiliano'),
    'BRR' => new C('BRR', 'cruzeiro brasiliano'),
    'BRZ' => new C('BRZ'),
    'BSD' => new C('BSD', 'dollaro delle Bahamas', plurals: ['one' => 'dollaro delle Bahamas', 'other' => 'dollari delle Bahamas']),
    'BTN' => new C('BTN', 'ngultrum bhutanese', plurals: ['one' => 'ngultrum bhutanese', 'other' => 'ngultrum bhutanesi']),
    'BUK' => new C('BUK', 'kyat birmano'),
    'BWP' => new C('BWP', 'pula del Botswana', plurals: ['one' => 'pula del Botswana', 'other' => 'pula del Botswana']),
    'BYB' => new C('BYB', 'nuovo rublo bielorusso (1994–1999)'),
    'BYN' => new C('BYN', 'rublo bielorusso', plurals: ['one' => 'rublo bielorusso', 'other' => 'rubli bielorussi']),
    'BYR' => new C('BYR', 'rublo bielorusso (2000–2016)', plurals: ['one' => 'rublo bielorusso (2000–2016)', 'other' => 'rubli bielorussi (2000–2016)']),
    'BZD' => new C('BZD', 'dollaro del Belize', plurals: ['one' => 'dollaro del Belize', 'other' => 'dollari del Belize']),
    'CAD' => new C('CAD', 'dollaro canadese', 'CA$', plurals: ['one' => 'dollaro canadese', 'other' => 'dollari canadesi']),
    ...
    'CLP' => new C('CLP', 'peso cileno', plurals: ['one' => 'peso cileno', 'other' => 'pesos cileni'], minorUnits: 0),
    'CNH' => new C('CNH', 'renmimbi cinese offshore', plurals: ['one' => 'renmimbi cinese offshore', 'other' => 'renmimbi cinesi offshore']),
    'CNX' => new C('CNX'),
    'CNY' => new C('CNY', 'renminbi cinese', 'CN¥', plurals: ['one' => 'renmimbi cinese', 'other' => 'renmimbi cinesi']),
    'COP' => new C('COP', 'peso colombiano', plurals: ['one' => 'peso colombiano', 'other' => 'pesos colombiani']),
    'COU' => new C('COU'),
    'CRC' => new C('CRC', 'colón costaricano', plurals: ['one' => 'colón costaricano', 'other' => 'colón costaricani']),
    'CSD' => new C('CSD', 'antico dinaro serbo'),
    'CSK' => new C('CSK', 'corona forte cecoslovacca'),
    'CUC' => new C('CUC', 'peso cubano convertibile', plurals: ['one' => 'peso cubano convertibile', 'other' => 'pesos cubani convertibili']),
    'CUP' => new C('CUP', 'peso cubano', plurals: ['one' => 'peso cubano', 'other' => 'pesos cubani']),
    ...
    'CZK' => new C('CZK', 'corona ceca', plurals: ['one' => 'corona ceca', 'other' => 'corone ceche']),
    ...
    'DKK' => new C('DKK', 'corona danese', plurals: ['one' => 'corona danese', 'other' => 'corone danesi']),
    'DOP' => new C('DOP', 'peso dominicano', plurals: ['one' => 'peso dominicano', 'other' => 'pesos dominicani']),
    ...
    'EGP' => new C('EGP', 'sterlina egiziana', plurals: ['one' => 'sterlina egiziana', 'other' => 'sterline egiziane']),
    ...
    'FJD' => new C('FJD', 'dollaro delle Figi', plurals: ['one' => 'dollaro delle Figi', 'other' => 'dollari delle Figi']),
    'FKP' => new C('FKP', 'sterlina delle Falkland', plurals: ['one' => 'sterlina delle Falkland', 'other' => 'sterline delle Falkland']),
    'FRF' => new C('FRF', 'franco francese'),
    'GBP' => new C('GBP', 'sterlina britannica', '£', plurals: ['one' => 'sterlina britannica', 'other' => 'sterline britanniche']),
    'GEK' => new C('GEK', 'kupon larit georgiano'),
    'GEL' => new C('GEL', 'lari georgiano', plurals: ['one' => 'lari georgiano', 'other' => 'lari georgiani']),
    'GHC' => new C('GHC', 'cedi del Ghana'),
    'GHS' => new C('GHS', 'cedi ghanese', plurals: ['one' => 'cedi ghanese', 'other' => 'cedi ghanesi']),
    'GIP' => new C('GIP', 'sterlina di Gibilterra', plurals: ['one' => 'sterlina di Gibilterra', 'other' => 'sterline di Gibilterra']),
    'GMD' => new C('GMD', 'dalasi gambiano', plurals: ['one' => 'dalasi gambiano', 'other' => 'dalasi gambiani']),
    'GNF' => new C('GNF', 'franco della Guinea', plurals: ['one' => 'franco della Guinea', 'other' => 'franchi della Guinea'], minorUnits: 0),
    'GNS' => new C('GNS', 'syli della Guinea'),
    'GQE' => new C('GQE', 'ekwele della Guinea Equatoriale'),
    'GRD' => new C('GRD', 'dracma greca'),
    'GTQ' => new C('GTQ', 'quetzal guatemalteco', plurals: ['one' => 'quetzal guatemalteco', 'other' => 'quetzal guatemaltechi']),
    'GWE' => new C('GWE', 'escudo della Guinea portoghese'),
    'GWP' => new C('GWP', 'peso della Guinea-Bissau'),
    'GYD' => new C('GYD', 'dollaro della Guyana', plurals: ['one' => 'dollaro della Guyana', 'other' => 'dollari della Guyana']),
    'HKD' => new C('HKD', 'dollaro di Hong Kong', plurals: ['one' => 'dollaro di Hong Kong', 'other' => 'dollari di Hong Kong']),
    'HNL' => new C('HNL', 'lempira honduregna', plurals: ['one' => 'lempira honduregna', 'other' => 'lempire honduregne']),
    'HRD' => new C('HRD', 'dinaro croato'),
    'HRK' => new C('HRK', 'kuna croata', plurals: ['one' => 'kuna croata', 'other' => 'kune croate']),
    'HTG' => new C('HTG', 'gourde haitiano', plurals: ['one' => 'gourde haitiano', 'other' => 'gourde haitiani']),
    'HUF' => new C('HUF', 'fiorino ungherese', plurals: ['one' => 'fiorino ungherese', 'other' => 'fiorini ungheresi']),
    'IDR' => new C('IDR', 'rupia indonesiana', plurals: ['one' => 'rupia indonesiana', 'other' => 'rupie indonesiane']),
    'IEP' => new C('IEP', 'sterlina irlandese'),
    'ILP' => new C('ILP', 'sterlina israeliana'),
    'ILR' => new C('ILR'),
    'ILS' => new C('ILS', 'nuovo siclo israeliano', '₪', plurals: ['one' => 'nuovo siclo israeliano', 'other' => 'nuovi sicli israeliani']),
    'INR' => new C('INR', 'rupia indiana', plurals: ['one' => 'rupia indiana', 'other' => 'rupie indiane']),
    ...
    'ISJ' => new C('ISJ'),
    'ISK' => new C('ISK', 'corona islandese', plurals: ['one' => 'corona islandese', 'other' => 'corone islandesi'], minorUnits: 0),
    'ITL' => new C('ITL', 'lira italiana', plurals: ['one' => 'lire italiane', 'other' => 'lire italiane']),
    'JMD' => new C('JMD', 'dollaro giamaicano', plurals: ['one' => 'dollaro giamaicano', 'other' => 'dollari giamaicani']),
    'JOD' => new C('JOD', 'dinaro giordano', plurals: ['one' => 'dinaro giordano', 'other' => 'dinari giordani'], minorUnits: 3),
    'JPY' => new C('JPY', 'yen giapponese', plurals: ['one' => 'yen giapponese', 'other' => 'yen giapponesi'], minorUnits: 0),
    ...
    'KHR' => new C('KHR', 'riel cambogiano', plurals: ['one' => 'riel cambogiano', 'other' => 'riel cambogiani']),
    'KMF' => new C('KMF', 'franco comoriano', plurals: ['one' => 'franco comoriano', 'other' => 'franchi comoriani'], minorUnits: 0),
    'KPW' => new C('KPW', 'won nordcoreano', plurals: ['one' => 'won nordcoreano', 'other' => 'won nordcoreani']),
    'KRH' => new C('KRH'),
    'KRO' => new C('KRO'),
    'KRW' => new C('KRW', 'won sudcoreano', plurals: ['one' => 'won sudcoreano', 'other' => 'won sudcoreani'], minorUnits: 0),
    'KWD' => new C('KWD', 'dinaro kuwaitiano', plurals: ['one' => 'dinaro kuwaitiano', 'other' => 'dinari kuwaitiani'], minorUnits: 3),
    'KYD' => new C('KYD', 'dollaro delle Isole Cayman', plurals: ['one' => 'dollaro delle Isole Cayman', 'other' => 'dollari delle Isole Cayman']),
    'KZT' => new C('KZT', 'tenge kazako', plurals: ['one' => 'tenge kazako', 'other' => 'tenge kazaki']),
    'LAK' => new C('LAK', 'kip laotiano', plurals: ['one' => 'kip laotiano', 'other' => 'kip laotiani']),
    'LBP' => new C('LBP', 'lira libanese', plurals: ['one' => 'lira libanese', 'other' => 'lire libanesi']),
    'LKR' => new C('LKR', 'rupia di Sri Lanka', plurals: ['one' => 'rupia di Sri Lanka', 'other' => 'rupie di Sri Lanka']),
    'LRD' => new C('LRD', 'dollaro liberiano', plurals: ['one' => 'dollaro liberiano', 'other' => 'dollari liberiani']),
    'LSL' => new C('LSL', 'loti del Lesotho'),
    'LTL' => new C('LTL', 'litas lituano', plurals: ['one' => 'litas lituano', 'other' => 'litas lituani']),
    ...
    'LVL' => new C('LVL', 'lats lettone', plurals: ['one' => 'lats lettone', 'other' => 'lati lettoni']),
    ...
    'MGA' => new C('MGA', 'ariary malgascio', plurals: ['one' => 'ariary malgascio', 'other' => 'ariary malgasci']),
    ...
    'MMK' => new C('MMK', 'kyat di Myanmar', plurals: ['one' => 'kyat di Myanmar', 'other' => 'kyat di Myanmar']),
    'MNT' => new C('MNT', 'tugrik mongolo', plurals: ['one' => 'tugrik mongolo', 'other' => 'tugrik mongoli']),
    ...
    'MUR' => new C('MUR', 'rupia mauriziana', plurals: ['one' => 'rupia mauriziana', 'other' => 'rupie mauriziane']),
    'MVP' => new C('MVP'),
    ...
    'MXN' => new C('MXN', 'peso messicano', plurals: ['one' => 'peso messicano', 'other' => 'pesos messicani']),
    'MXP' => new C('MXP', 'peso messicano d’argento (1861–1992)'),
    'MXV' => new C('MXV', 'unidad de inversion (UDI) messicana'),
    'MYR' => new C('MYR', 'ringgit malese', plurals: ['one' => 'ringgit malese', 'other' => 'ringgit malesi']),
    ...
    'NAD' => new C('NAD', 'dollaro namibiano', plurals: ['one' => 'dollaro namibiano', 'other' => 'dollari namibiani']),
    'NGN' => new C('NGN', 'naira nigeriana', plurals: ['one' => 'naira nigeriana', 'other' => 'naire nigeriane']),
    'NIC' => new C('NIC', 'cordoba nicaraguense', plurals: ['one' => 'cordoba nicaraguense', 'other' => 'cordoba nicaraguense']),
    'NIO' => new C('NIO', 'córdoba nicaraguense', plurals: ['one' => 'córdoba nicaraguense', 'other' => 'córdoba nicaraguensi']),
    'NLG' => new C('NLG', 'fiorino olandese'),
    'NOK' => new C('NOK', 'corona norvegese', plurals: ['one' => 'corona norvegese', 'other' => 'corone norvegesi']),
    'NPR' => new C('NPR', 'rupia nepalese', plurals: ['one' => 'rupia nepalese', 'other' => 'rupie nepalesi']),
    'NZD' => new C('NZD', 'dollaro neozelandese', 'NZ$', plurals: ['one' => 'dollaro neozelandese', 'other' => 'dollari neozelandesi']),
    ...
    'PHP' => new C('PHP', 'peso filippino', '₱', plurals: ['one' => 'peso filippino', 'other' => 'pesos filippini']),
    'PKR' => new C('PKR', 'rupia pakistana', plurals: ['one' => 'rupia pakistana', 'other' => 'rupie pakistane']),
    'PLN' => new C('PLN', 'złoty polacco', plurals: ['one' => 'złoty polacco', 'other' => 'złoty polacchi']),
    ...
    'PYG' => new C('PYG', 'guaraní paraguayano', plurals: ['one' => 'guaraní paraguayano', 'other' => 'guaraní paraguayani'], minorUnits: 0),
    ...
    'RON' => new C('RON', 'leu rumeno', plurals: ['one' => 'leu rumeno', 'other' => 'lei rumeni']),
    'RSD' => new C('RSD', 'dinaro serbo', plurals: ['one' => 'dinaro serbo', 'other' => 'dinara serbi']),
    'RUB' => new C('RUB', 'rublo russo', plurals: ['one' => 'rublo russo', 'other' => 'rubli russi']),
    'RUR' => new C('RUR', 'rublo della CSI'),
    'RWF' => new C('RWF', 'franco ruandese', plurals: ['one' => 'franco ruandese', 'other' => 'franchi ruandesi'], minorUnits: 0),
    'SAR' => new C('SAR', 'riyal saudita', plurals: ['one' => 'riyal saudita', 'other' => 'riyal sauditi']),
    'SBD' => new C('SBD', 'dollaro delle Isole Salomone', plurals: ['one' => 'dollaro delle Isole Salomone', 'other' => 'dollari delle Isole Salomone']),
    ...
    'SDP' => new C('SDP'),
    'SEK' => new C('SEK', 'corona svedese', plurals: ['one' => 'corona svedese', 'other' => 'corone svedesi']),
    'SGD' => new C('SGD', 'dollaro di Singapore', plurals: ['one' => 'dollaro di Singapore', 'other' => 'dollari di Singapore']),
    'SHP' => new C('SHP', 'sterlina di Sant’Elena', plurals: ['one' => 'sterlina di Sant’Elena', 'other' => 'sterline di Sant’Elena']),
    ...
    'SRD' => new C('SRD', 'dollaro del Suriname', plurals: ['one' => 'dollaro del Suriname', 'other' => 'dollari del Suriname']),
    'SRG' => new C('SRG', 'fiorino del Suriname'),
    'SSP' => new C('SSP', 'sterlina sud-sudanese', plurals: ['one' => 'sterlina sud-sudanese', 'other' => 'sterline sud-sudanesi']),
    ...
    'STN' => new C('STN', 'dobra di Sao Tomé e Príncipe', plurals: ['one' => 'dobra di Sao Tomé e Príncipe', 'other' => 'dobra di Sao Tomé e Príncipe']),
    'SUR' => new C('SUR', 'rublo sovietico'),
    'SVC' => new C('SVC', 'colón salvadoregno'),
    'SYP' => new C('SYP', 'lira siriana', plurals: ['one' => 'lira siriana', 'other' => 'lire siriane']),
    'SZL' => new C('SZL', 'lilangeni dello Swaziland', plurals: ['one' => 'lilangeni dello Swaziland', 'other' => 'lilangeni dello Swaziland']),
    'THB' => new C('THB', 'baht thailandese', '฿', plurals: ['one' => 'baht thailandese', 'other' => 'baht thailandesi']),
    ...
    'TOP' => new C('TOP', 'paʻanga tongano', plurals: ['one' => 'paʻanga tongano', 'other' => 'paʻanga tongani']),
    ...
    'TRY' => new C('TRY', 'lira turca', plurals: ['one' => 'lira turca', 'other' => 'lire turche']),
    'TTD' => new C('TTD', 'dollaro di Trinidad e Tobago', plurals: ['one' => 'dollaro di Trinidad e Tobago', 'other' => 'dollari di Trinidad e Tobago']),
    'TWD' => new C('TWD', 'nuovo dollaro taiwanese', plurals: ['one' => 'nuovo dollaro taiwanese', 'other' => 'nuovi dollari taiwanesi']),
    'TZS' => new C('TZS', 'scellino della Tanzania', plurals: ['one' => 'scellino della Tanzania', 'other' => 'scellini della Tanzania']),
    'UAH' => new C('UAH', 'grivnia ucraina', plurals: ['one' => 'grivnia ucraina', 'other' => 'grivnie ucraine']),
    ...
    'USD' => new C('USD', 'dollaro statunitense', plurals: ['one' => 'dollaro statunitense', 'other' => 'dollari statunitensi']),
    ...
    'UYU' => new C('UYU', 'peso uruguayano', plurals: ['one' => 'peso uruguayano', 'other' => 'pesos uruguayani']),
    ...
    'VEF' => new C('VEF', 'bolívar venezuelano (2008–2018)', plurals: ['one' => 'bolívar venezuelano (2008–2018)', 'other' => 'bolívares venezuelani (2008–2018)']),
    'VES' => new C('VES', 'bolívar venezuelano', plurals: ['one' => 'bolívar venezuelano', 'other' => 'bolívares venezuelani']),
    'VND' => new C('VND', 'dong vietnamita', plurals: ['one' => 'dong vietnamita', 'other' => 'dong vietnamiti'], minorUnits: 0),
    'VNN' => new C('VNN'),
    ...
    'XCD' => new C('XCD', 'dollaro dei Caraibi orientali', 'EC$', plurals: ['one' => 'dollaro dei Caraibi orientali', 'other' => 'dollari dei Caraibi orientali']),
    ...
    'ZAR' => new C('ZAR', 'rand sudafricano', plurals: ['one' => 'rand sudafricano', 'other' => 'rand sudafricani']),
    'ZMK' => new C('ZMK', 'kwacha dello Zambia (1968–2012)', plurals: ['one' => 'kwacha zambiano (1968–2012)', 'other' => 'kwacha zambiani (1968–2012)']),
    'ZMW' => new C('ZMW', 'kwacha zambiano', plurals: ['one' => 'kwacha zambiano', 'other' => 'kwacha zambiani']),
