...
return [
    'AUD' => new C('AUD', 'دالر آسترالیا', 'A$', '$', 'دلار استرالیا'),
    ...
    'CAD' => new C('CAD', 'دالر کانادا', '$CA', '$', 'دلار کانادا'),
    'CHF' => new C('CHF', 'فرانک سویس', plurals: 'فرانک سوئیس'),
    'DKK' => new C('DKK', 'کرون دنمارک', narrow: 'kr', plurals: 'کرون دانمارک'),
    'JPY' => new C('JPY', 'ین جاپان', '¥', '¥', 'ین ژاپن', 0),
    'MXN' => new C('MXN', 'پزوی مکسیکو', '$MX', '$', 'پزوی مکزیک'),
    ...
    'USD' => new C('USD', 'دالر امریکا', '$', '$', 'دلار آمریکا'),
];
