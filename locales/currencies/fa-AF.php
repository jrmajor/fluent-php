...
return [
    ...
    'BYN' => new C('BYN', 'روبل روسیهٔ سفید', narrow: 'р.', plurals: ['one' => 'روبل بلاروسی', 'other' => 'روبل بلاروسی']),
    ...
    'USD' => new C('USD', 'دالر امریکا', '$', narrow: '$', plurals: ['one' => 'دلار امریکا', 'other' => 'دلار امریکا']),
];
