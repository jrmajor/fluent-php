...
return [
    ...
    'CNY' => new C('CNY', 'Yuan Tyongkok', 'CN¥', narrow: '¥', plurals: 'Yuan Tyongkok'),
    ...
    'ILS' => new C('ILS', 'Shekel Anyar Israel', '₪', narrow: '₪', plurals: 'Shekel Anyar Israel'),
    ...
    'KRW' => new C('KRW', 'Won Korea Kidul', '₩', narrow: '₩', plurals: 'Won Korea Kidul', minorUnits: 0),
    ...
    'NZD' => new C('NZD', 'Dolar Selandia Anyar', 'NZ$', narrow: '$', plurals: 'Dolar Selandia Anyar'),
    ...
    'PHP' => new C('PHP', 'Piso Filipina', '₱', narrow: '₱', plurals: 'Piso Filipina'),
    ...
    'TWD' => new C('TWD', 'Dolar Anyar Taiwan', 'NT$', narrow: '$', plurals: 'Dolar Anyar Taiwan'),
    ...
    'XCD' => new C('XCD', 'Dolar Karibia Wetan', 'EC$', narrow: '$', plurals: 'Dolar Karibia Wetan'),
