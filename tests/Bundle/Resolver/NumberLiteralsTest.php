...
it('formats numbers in placeables according to current locale')
    ...
    ->and($pl->message('num-in-placeable'))->toBe("332\u{00A0}035\u{00A0}625,33203")
    ->and($zh->message('num-in-placeable'))->toBe('332,035,625.33203')
    ->and($fr->message('num-in-placeable'))->toBe("332\u{00A0}035\u{00A0}625,33203");
...
it('formats numbers in variables according to current locale')
    ...
    ->and($pl->message('num-in-var', number: 37_824_787.378_24))->toBe("37\u{00A0}824\u{00A0}787,378")
    ->and($zh->message('num-in-var', number: 37_824_787.378_24))->toBe('37,824,787.378')
    ->and($fr->message('num-in-var', number: 37_824_787.378_24))->toBe("37\u{00A0}824\u{00A0}787,378");
